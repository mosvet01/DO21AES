...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.ПраваДоступа.ВертикальнаяПолосаПрокрутки = ИспользованиеПолосыПрокрутки.ИспользоватьВсегда;
	Элементы.ПраваДоступа.ВариантУправленияВысотой = ВариантУправленияВысотойТаблицы.ВСтрокахТаблицы;
