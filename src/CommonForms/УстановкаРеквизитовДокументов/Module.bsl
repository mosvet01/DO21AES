...
Процедура УстановитьВидимостьРеквизитов()
	...
	Иначе
		ВызватьИсключение НСтр("ru = 'Некорректный вид справочника документов.'");
	КонецЕсли;
...
Процедура ПриСозданииНаСервереРедакцииКонфигурации()	
	...
	Элементы.ВнутренниеДокументыОрганизация.Заголовок = РедакцииКонфигурацииКлиентСервер.Организация();
	Элементы.ВходящиеДокументыОрганизация.Заголовок = РедакцииКонфигурацииКлиентСервер.Организация();
	Элементы.ИсходящиеДокументыОрганизация.Заголовок = РедакцииКонфигурацииКлиентСервер.Организация();
