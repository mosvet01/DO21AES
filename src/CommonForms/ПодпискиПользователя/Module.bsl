...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ГруппаПользователь.Видимость = ЭтоПолноправныйПользователь;
	
	ЭтоПользовательМП = Справочники.ПользователиМобильногоПриложения.ЭтоПользовательМП(Пользователь);
	Элементы.ПодпискиПоОбъектамПоPushСтрокой.Видимость = ЭтоПользовательМП;
	Элементы.ПодпискиУведомленийПоPush.Видимость = ЭтоПользовательМП;
