...
Процедура ОбновитьРезультатПроверкиПодписи(АдресСвойствПодписи, Результат)
	...
	Иначе
		...
		Если Результат.Свойство("ТекстОшибкиПроверкиПодписи") Тогда
			СвойстваПодписи.ПодписьВерна = Ложь;
			СвойстваПодписи.ТекстОшибкиПроверкиПодписи = Результат.ТекстОшибкиПроверкиПодписи;
		КонецЕсли;
		
		Если Результат.Свойство("ТекстОшибкиПроверкиСертификата") Тогда
			СвойстваПодписи.СертификатДействителен = Ложь;
			СвойстваПодписи.ТекстОшибкиПроверкиСертификата = Результат.ТекстОшибкиПроверкиСертификата;
		КонецЕсли;
	КонецЕсли;
