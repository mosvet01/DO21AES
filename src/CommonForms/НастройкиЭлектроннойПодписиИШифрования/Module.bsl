...
&НаКлиенте
Процедура СохранятьДоверенностиВместеСПодписьюПриИзменении(Элемент)
	СохранитьНастройки();
КонецПроцедуры
...
Процедура ЗаполнитьПрограммыИНастройки(ОбновитьПовтИсп = Ложь)
	...
	СохранятьДоверенностиВместеСПодписью       = ПерсональныеНастройки.СохранятьДоверенность;
	...
	Для каждого СтрокаВыборки Из ТаблицаВыборки Цикл
		...
		Иначе
			...
			Для Каждого СтрокаСертификата Из ТаблицаСертификатов Цикл
				Если СтрокаСертификата.Программа <> СтрокаВыборки.Ссылка Тогда
					Продолжить;
				КонецЕсли;
...
Процедура СохранитьНастройки()
	...
	СохраняемыеНастройки.Вставить("СохранятьДоверенность",                      СохранятьДоверенностиВместеСПодписью);
