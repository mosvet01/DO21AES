...
Процедура ДоверенностиОрганизацийПриАктивацииСтроки(Элемент)
	...
	ПодключитьОбработчикОжидания("ДоверенностиОрганизацийПриАктивацииСтрокиОбработчик", 0.1, Истина);
...
&НаКлиенте
Процедура ДоверенностиОрганизацийПриАктивацииСтрокиОбработчик()
	
	ТекущиеДанные = Элементы.ДоверенностиОрганизаций.ТекущиеДанные;
	Если ТекущиеДанные <> Неопределено Тогда
		Элементы.ДоверенностиОрганизаций_Отменить.Видимость = ДоверенностьДействительна(ТекущиеДанные.Ссылка);
	КонецЕсли;
	
КонецПроцедуры

&НаСервереБезКонтекста
Функция ДоверенностьДействительна(Доверенность)
	
	Возврат МашиночитаемыеДоверенности.ДоверенностьДействительна(Доверенность, ТекущаяДатаСеанса());
