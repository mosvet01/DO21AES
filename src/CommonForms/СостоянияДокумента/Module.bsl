...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДелопроизводствоКлиентСервер.ЭтоВходящийДокумент(Документ) Тогда
		...
		Элементы.СостояниеРегистрация.СписокВыбора.Добавить(Перечисления.СостоянияДокументов.НаРегистрации);
		Элементы.СостояниеРегистрация.СписокВыбора.Добавить(Перечисления.СостоянияДокументов.Зарегистрирован);
		Элементы.СостояниеРегистрация.СписокВыбора.Добавить(Перечисления.СостоянияДокументов.НеЗарегистрирован);
	КонецЕсли;
