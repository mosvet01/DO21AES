...
Процедура ДобавитьВОтчетПослеВыполненияЗадачи(ОпцияВестиУчетТрудозатрат,
	...
	ДобавлятьВОтчет = СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиента().ПерсональныеНастройкиУчетаВремени.ДобавлятьРаботуВЕжедневныйОтчетПриВыполненииЗадачи;
	ПараметрыОтчета = Неопределено;
	ПараметрыОповещения = Неопределено;
