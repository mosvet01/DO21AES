...
// Возвращаемое значение:
//  Структура:
// * ВсеДокументы - см. СервисЭДО.ПолучитьДокументы
// * НеЗагруженныеВБазуДокументы - см. СервисЭДО.ПолучитьДокументы
Функция ПолучитьОписаниеДокументов(КлючСинхронизации, ДатаПоследнегоЗапроса, КонтекстДиагностики)
...
Процедура ОтправитьЭлектронныеДокументыПоРасписанию() Экспорт
	...
	МиграцияДанныхИзВнешнихСистемСервер.ПриНачалеРаботыРегламентногоЗадания(
		Метаданные.РегламентныеЗадания.ОтправкаЭлектронныхДокументов);
