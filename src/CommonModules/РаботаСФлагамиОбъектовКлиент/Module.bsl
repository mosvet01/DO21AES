...
//
//  Параметры:
//  - ФормаОбъект - ФормаКлиентскогоПриложения - форма объекта, в которой находятся элементы управления
...
Процедура УстановитьФлагВФормеОбъекта(ФормаОбъект, ЗначениеФлага, ЗначениеКартинки) Экспорт
	...
	Исключение
		ВызватьИсключение НСтр("ru = 'Ошибка при обращении к реквизиту Флаг в форме!'");
		Возврат;
	КонецПопытки;
	...
	Исключение
		ВызватьИсключение НСтр("ru = 'Ошибка при установке флага объекту из Формы!'");
		Возврат;
	КонецПопытки;
