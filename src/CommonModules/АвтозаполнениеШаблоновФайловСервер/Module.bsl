	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Пока ДанныеДляЗамены.Следующий() Цикл
			...
			Если Лев(ДанныеДляЗамены.ЗначениеЗамены, 1) = "{"
				...
				И Найти(ДанныеДляЗамены.ЗначениеЗамены, "ТабличнаяЧасть") > 0 Тогда
				Попытка
			...
			ИначеЕсли Лев(ДанныеДляЗамены.ЗначениеЗамены, 1) = "{"
				И Прав(ДанныеДляЗамены.ЗначениеЗамены, 1) = "}"
				И Найти(ДанныеДляЗамены.ЗначениеЗамены, "ДопРеквизиты") = 0
				И Найти(ДанныеДляЗамены.ЗначениеЗамены, "ДопСвойства") = 0
				И Найти(ДанныеДляЗамены.ЗначениеЗамены, "КонтактнаяИнформация") = 0 Тогда
				Попытка
			...
			ИначеЕсли Лев(ДанныеДляЗамены.ЗначениеЗамены, 1) = "{"
				И Прав(ДанныеДляЗамены.ЗначениеЗамены, 1) = "}"
				И (Найти(ДанныеДляЗамены.ЗначениеЗамены, "ДопРеквизиты") > 0
				Или Найти(ДанныеДляЗамены.ЗначениеЗамены, "ДопСвойства") > 0) Тогда
