...
Функция ПрочитатьАрхив(Поток) Экспорт
	...
	Если КонецКаталога.СмещениеКаталога = ЧислоИзШестнадцатеричнойСтроки("0xFFFFFFFF") 
		...
		КонецКаталога64 = КонецКаталога64(Поток, Локатор64.Смещение);
...
// Возвращаемое значение: 
//  БуферДвоичныхДанных
Функция НовыйКонецКаталога(КоличествоЗаписей, РазмерКаталога, СмещениеКаталога) Экспорт
...
// Возвращаемое значение: 
//  БуферДвоичныхДанных
Функция НовыйКонецКаталога64(ВсегоЗаписей, РазмерКаталога, СмещениеКаталога) Экспорт
...
// Возвращаемое значение: 
//  БуферДвоичныхДанных
Функция НовыйЛокатор64(СмещениеКонецКаталога64) Экспорт
...
// * ИмяФайла - Строка
//
Функция ПрочитатьЗаписьКаталога(Буфер, Смещение) Экспорт
...
Функция КонецКаталога64(Поток, Начало)
	
	КонецКаталога = ПолучитьБайты(Поток, Начало, 56);
