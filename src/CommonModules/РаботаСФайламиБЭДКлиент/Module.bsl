...
Процедура СохранитьФайлВыгрузкиКак(ДанныеФайлаВыгрузки, СсылкаНаДвоичныеДанныеФайла,
	...
	ДанныеФайла.Вставить("НавигационнаяСсылкаТекущейВерсии", СсылкаНаДвоичныеДанныеФайла);
	...
	ДанныеФайла.Вставить("Версия", Неопределено);
	ДанныеФайла.Вставить("ТекущаяВерсия", Неопределено);
	
	РаботаСФайламиСлужебныйКлиент.СохранитьКак(ОбработчикЗавершения, ДанныеФайла, Неопределено);
