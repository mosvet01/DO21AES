...
Процедура ПроверитьНазначениеРолей(НазначениеРолей = Неопределено, ПроверитьВсе = Ложь, СписокОшибок = Неопределено) Экспорт
	...
	Если ОбщегоНазначения.РазделениеВключено() Или ПроверитьВсе Тогда
		...
		НедоступныеПрава.Добавить("РежимТехническогоСпециалиста");
...
Процедура ПриОпределенииОбъектовСНачальнымЗаполнением(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Справочники.РабочиеГруппы);
...
//                     - Соответствие из КлючИЗначение:
//                         * Ключ - СправочникСсылка.РабочиеГруппы - заполняет соответствие
...
//  ИзмененныеГруппы   - Неопределено - никаких действий.
//                     - Соответствие из КлючИЗначение:
//                         * Ключ - СправочникСсылка.РабочиеГруппы
...
//
// Параметры:
//  ГруппаПриемник     - СправочникСсылка.РабочиеГруппы
...
Процедура ВыбратьПользователейГруппы(ВыбранныеЭлементы, ХранимыеПараметры, ПолеСписка) Экспорт 
	...
	Если ТипВыбранногоЭлемента = Тип("СправочникСсылка.РабочиеГруппы")
		...
		Или ТипВыбранногоЭлемента <> Тип("СправочникСсылка.РабочиеГруппы")
...
Процедура ЗаполнитьНаименованиеПредопределенныхГруппПользователей() Экспорт
	...
	УстановитьНаименование(Справочники.РабочиеГруппы.ВсеПользователи,
...
//            - СправочникСсылка.РабочиеГруппы - ссылка на элемент справочника.
//   * Родитель - СправочникСсылка.ГруппыВнешнихПользователей
//              - СправочникСсылка.РабочиеГруппы - ссылка на родителя
