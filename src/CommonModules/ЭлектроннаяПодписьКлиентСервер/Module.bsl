...
//     * УникальныйИдентификатор     - УникальныйИдентификатор - идентификатор подписи, по которому можно упорядочивать их в списке.
...
Функция НовыеСвойстваПодписи() Экспорт
	...
	Структура.Вставить("СертификатДействителен");
	Структура.Вставить("ТекстОшибкиПроверкиПодписи");
	Структура.Вставить("ТекстОшибкиПроверкиСертификата");
	Структура.Вставить("СтатусПроверкиЭП");
