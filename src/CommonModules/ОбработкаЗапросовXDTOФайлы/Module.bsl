...
//   ПодписанныйОбъект - СправочникСсылка.Файлы,
//                     СправочникСсылка.ВнутренниеДокументы,
//                     СправочникСсылка.ВходящиеДокументы,
//                     СправочникСсылка.ИсходящиеДокументы - ссылка на подписанный объект.
//
Процедура ЗанестиИнформациюОПодписяхОбъекта(signatures, ПодписанныйОбъект) Экспорт
	...
	Для Каждого ПодписьСтруктура Из signatures Цикл
		...
		ОбработкаЗапросовXDTO.ЗаполнитьРеквизитИзСвойстваXDTO(УстановившийПодпись, ПодписьСтруктура, "signer");
		Если Не ЗначениеЗаполнено(УстановившийПодпись)
				Или (ЗначениеЗаполнено(УстановившийПодпись)
					И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(УстановившийПодпись))
					И Не ОбщегоНазначения.СсылкаСуществует(УстановившийПодпись)) Тогда
