...
Процедура ОбновитьСвязиЭлементовСхемыПроцесса(СхемаПроцесса, ГрафическаяСхема) Экспорт
	...
	Для Каждого ЭлементГрафическойСхемы Из ГрафическаяСхема.ЭлементыГрафическойСхемы Цикл
		...
		Если ТипЭлементаНачала = Тип("ЭлементГрафическойСхемыУсловие") Тогда
			...
			НоваяЗаписьПредшественника.РезультатУсловияПредшественника = 
				РезультатУсловияПредшественникаПоНаименованиюЛинии(
...
// Возвращает результат условия предшественника по наименованию линии.
// 
// Параметры:
//  НаименованиеЛинии - Строка - Наименование линии
// 
// Возвращаемое значение:
//  Булево
//
Функция РезультатУсловияПредшественникаПоНаименованиюЛинии(НаименованиеЛинии)
	
	НаименованияПоложительныхРезультатов = Новый Соответствие;
	НаименованияПоложительныхРезультатов["Да"] = Истина;
	НаименованияПоложительныхРезультатов["Yes"] = Истина;
	
	Если НаименованияПоложительныхРезультатов[НаименованиеЛинии] = Истина Тогда
		Возврат Истина;
	КонецЕсли;
