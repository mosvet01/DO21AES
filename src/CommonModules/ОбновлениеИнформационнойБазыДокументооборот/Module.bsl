...
Функция ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_28_3";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.5";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("03dd838d-bf36-4a8b-ab3d-f11de73f4e7e");
	Обработчик.Процедура = "РегистрыСведений.НастройкиОтправкиДокументовПоЭДО.ЗаполнитьВидДокументаЭДОВПравилахОтправки";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление правил отправки видов внутренних документов по ЭДО'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.6";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("bf1a440b-efda-4285-a91a-ff371609807d");
	Обработчик.Процедура = "РегистрыСведений.ПравилаУчетаВидовЭДДО.ЗаполнитьВидДокументаЭДОВПравилахУчета";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление правил создания внутренних документов по документам ЭДО'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.7";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("d6820580-0684-4945-bb3c-a4afcbbc1cc9");
	Обработчик.Процедура = "РегистрыСведений.ОчередьПриемаСообщенийЭДО.ЗаполнитьСообщенияЭДОПоФайламОчередиПриема";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление очереди создания внутренних документов по документам ЭДО'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.8";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("526a1817-ec48-4b7c-8dbf-d8ae8c3c7153");
	Обработчик.Процедура = "РегистрыСведений.ПравилаУчетаВидовЭДДО.ЗаменитьПараметрыЗаполненияТекстовыхПолей";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий =
		НСтр("ru ='Обновление параметров текстовых полей создания внутренних документов по документам ЭДО'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.9";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_28_9";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.11";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_28_11";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.28.12";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_28_12";
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_3");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_4");
	
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_29_5",
		"РегистрыСведений.СостояниеДокументовПоЭДО.УстановитьСтатусПодписанДляИсходящихДокументовЭДО",
		"0ad752bf-959a-4ac6-8183-285ffb910efe",
		НСтр("ru = 'Обновление состояний ЭДО документов 1С:Документооборот. Установка состояния ""Подписан"" исходящих.'"));
		
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_6");
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_29_8",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_29_8",
		"5634c0f7-97ca-435c-9343-46c5f2e691a6",
		НСтр("ru = 'Исправление отображения недействительных записей в адресной книге.'"));
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_29_9",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_29_9",
		"2bb5a985-022c-48e1-b7ac-771c7a704de5",
		НСтр("ru = 'Исправление недействительных данных поиска в адресной книге.'"));
		
	ДобавитьСтандартныйОтложенныйОбработчик(Обработчики,
		"2_1_29_10",
		"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_29_10",
		"2bb5a925-012c-18e1-b8ac-721c7a704de7",
		НСтр("ru = 'Обновление фотографий пользователей.'"));
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_12");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_13");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_29_17");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_30_4");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_31_1");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_31_2");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_31_3");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_31_4");
	
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_32_3");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_32_4");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_32_5");
	ДобавитьСтандартныйОбработчик(Обработчики, "2_1_32_6");
...
Процедура ДобавитьСтандартныйОбработчик(Обработчики, Версия)
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_" + Версия;
...
//  ИмяПроцедуры	 - Строка - Имя процедуры в модуле ОбновлениеИнформационнойБазыДокументооборот,
//								которая будет выполнена при отложенном обновлении
...
Процедура ПриДобавленииОбработчиковПереходаСДругойПрограммы(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.ПредыдущееИмяКонфигурации  = ПредыдущееИмяКонфигурации;
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_32_1_СПРОФНаКОРП";
...
Процедура ПервыйЗапуск() Экспорт
	...
	// При обновлении с другой программы, заполнение не делаем
	Если ОбновлениеИнформационнойБазыСлужебный.РежимОбновленияДанных() = "ОбновлениеВерсии" Тогда 
		Возврат;
	КонецЕсли;
	...
	СоздатьВидБизнесСобытий(
		Справочники.ВидыБизнесСобытий.ИзменениеСостоянияДокументаОбменСКО,
		НСтр("ru='Изменение состояния документа (обмен с контролирующими органами)'"));
...
Процедура ПервыйЗапуск_СПРОФНаКОРП() Экспорт
	...
	ОбновитьДоступностьШаблонов();
	
	НастроитьЧатБота();
	
	Константы.ПолитикаУчетаРабочегоВремени.Установить(Перечисления.ПолитикиУчетаРабочегоВремени.ИспользоватьЕжедневныеОтчеты);
...
Процедура ПерейтиНаВерсию_2_1_32_1_СПРОФНаКОРП() Экспорт
	
	// Заполнение ежедневных отчетов при перезоде с ПРОФ на КОРП
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	ЕжедневныйОтчетУдалитьРаботы.Ссылка КАК ЕжОтчет,
		|	ВЫРАЗИТЬ(ФактическиеТрудозатраты.ОписаниеРаботы КАК СТРОКА(10)) КАК Поле1,
		|	ФактическиеТрудозатраты.Пользователь КАК Пользователь
		|ПОМЕСТИТЬ ВсеОтчеты
		|ИЗ
		|	Документ.ЕжедневныйОтчет.УдалитьРаботы КАК ЕжедневныйОтчетУдалитьРаботы
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ФактическиеТрудозатраты КАК ФактическиеТрудозатраты
		|		ПО ЕжедневныйОтчетУдалитьРаботы.Ссылка = ФактическиеТрудозатраты.ЕжедневныйОтчет
		|			И ((ВЫРАЗИТЬ(ЕжедневныйОтчетУдалитьРаботы.Работа КАК СТРОКА(50))) = (ВЫРАЗИТЬ(ФактическиеТрудозатраты.ОписаниеРаботы КАК СТРОКА(50))))
		|ГДЕ
		|	ФактическиеТрудозатраты.Пользователь ЕСТЬ NULL
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЕжедневныйОтчетУдалитьРаботы.Ссылка КАК Документ,
		|	ЕжедневныйОтчетУдалитьРаботы.ВидРабот КАК ВидРабот,
		|	ЕжедневныйОтчетУдалитьРаботы.Ссылка.Дата КАК ДатаДобавления,
		|	ЕжедневныйОтчетУдалитьРаботы.Длительность КАК Длительность,
		|	ЕжедневныйОтчетУдалитьРаботы.Источник КАК Источник,
		|	ЕжедневныйОтчетУдалитьРаботы.Начало КАК Начало,
		|	ЕжедневныйОтчетУдалитьРаботы.Окончание КАК Окончание,
		|	ЕжедневныйОтчетУдалитьРаботы.Проект КАК Проект,
		|	ЕжедневныйОтчетУдалитьРаботы.ПроектнаяЗадача КАК ПроектнаяЗадача,
		|	ЕжедневныйОтчетУдалитьРаботы.Работа КАК Работа,
		|	ЕжедневныйОтчетУдалитьРаботы.СозданаАвтоматически КАК СозданаАвтоматически,
		|	СведенияОПользователяхДокументооборот.Подразделение КАК Подразделение,
		|	ЕжедневныйОтчетУдалитьРаботы.Ссылка.Пользователь КАК Пользователь
		|ИЗ
		|	ВсеОтчеты КАК ВсеОтчеты
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЕжедневныйОтчет.УдалитьРаботы КАК ЕжедневныйОтчетУдалитьРаботы
		|		ПО (ЕжедневныйОтчетУдалитьРаботы.Ссылка = ВсеОтчеты.ЕжОтчет)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СведенияОПользователяхДокументооборот КАК СведенияОПользователяхДокументооборот
		|		ПО (СведенияОПользователяхДокументооборот.Пользователь = ЕжедневныйОтчетУдалитьРаботы.Ссылка.Пользователь)";
	Выборка = Запрос.Выполнить().Выбрать();
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			НаборЗаписей.Отбор.ДатаДобавления.Установить(Выборка.ДатаДобавления);
			...
			Иначе 
				...
				ЗаполнитьЗначенияСвойств(Запись, Выборка);
			КонецЕсли;
			Запись.ЕжедневныйОтчет = Выборка.Документ;
			Запись.ОписаниеРаботы = Выборка.Работа;
...
Процедура ПерейтиНаВерсию_2_0_1_11() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НовыйЭлемент.УдалитьПользовательОповещенОСрокеДействия = Ложь;
...
Процедура ПоставитьДокументыГотовыеКОтправкеПоЭДОВОчередь(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст =
			...
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОчередьСозданияОбъектовЭДО КАК ОчередьСозданияОбъектовЭДО
			|		ПО СостояниеДокументовПоЭДО.ДокументДО = ОчередьСозданияОбъектовЭДО.Документ
			|ГДЕ
			|	СостояниеДокументовПоЭДО.СостояниеВерсииДокументаПоЭДО = ЗНАЧЕНИЕ(Перечисление.СостоянияЭДОДокументооборот.ПоставленВОчередьНаОтправку)
			|	И СостояниеДокументовПоЭДО.НаправлениеЭД = ЗНАЧЕНИЕ(Перечисление.НаправленияЭДО.Исходящий)
			|	И ОчередьСозданияОбъектовЭДО.Документ ЕСТЬ NULL
			|
			|УПОРЯДОЧИТЬ ПО
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			РегистрыСведений.ОчередьСозданияОбъектовЭДО.ПоставитьВОчередь(Выборка.ДокументДО);
		Исключение
			ЗаписьЖурналаРегистрации(
				ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(),
				УровеньЖурналаРегистрации.Ошибка,,,
...
Процедура ПерейтиНаВерсию_2_1_28_3() Экспорт
	
	РаботаСФайламиВызовСервера.УстановитьСрокХраненияПротоколаРаботыССервисомРаспознаванияПоУмолчанию();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_28_9() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_28_11() Экспорт
	
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЧтениеРегистрацийВНалоговыхОрганахДокументооборот",
		"7bc7f2da-db69-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_28_12() Экспорт
	
	// Заполнение ССПД примитивными записями "Пользователь - Пользователь".
	Если Не ДокументооборотПраваДоступаПовтИсп.ВключеноИспользованиеПравДоступа()
		И Константы.ДокументооборотВключитьПраваДоступа.Получить() <> Истина Тогда
		Запрос = Новый Запрос(
			"ВЫБРАТЬ
...
Процедура ПерейтиНаВерсию_2_1_29_3() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2021Год(Истина, Истина);	
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_4() Экспорт
	
	Константы.ИспользоватьОтложеннуюОтправкуЭлектронныхДокументов.Установить(Ложь);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_6() Экспорт
	
	EmailКонтрагентаСсылка = Справочники.ВидыКонтактнойИнформации.EmailКонтрагента;
	EmailКонтрагентаВидРедактирования = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
		EmailКонтрагентаСсылка, "ВидРедактирования");
	Если EmailКонтрагентаВидРедактирования <> "ПолеВводаИДиалог" Тогда
		EmailКонтрагентаОбъект = EmailКонтрагентаСсылка.ПолучитьОбъект();
		EmailКонтрагентаОбъект.ВидРедактирования = "ПолеВводаИДиалог";
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(EmailКонтрагентаОбъект);
	КонецЕсли;
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_8(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		Запрос.Текст =  
			"ВЫБРАТЬ
			|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ АдреснаяКнигаПодчиненные.Ссылка) КАК ВсегоОбъектов
			|ИЗ
			|	Справочник.АдреснаяКнига КАК АдреснаяКнигаПодчиненные
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.АдреснаяКнига КАК АдреснаяКнигаРодители
			|		ПО АдреснаяКнигаПодчиненные.Родитель = АдреснаяКнигаРодители.Ссылка
			|ГДЕ
			|	АдреснаяКнигаРодители.ОтображатьВАдреснойКниге = ЛОЖЬ
			|	И (АдреснаяКнигаРодители.Объект ССЫЛКА Справочник.СтруктураПредприятия
			|	ИЛИ АдреснаяКнигаРодители.Объект ССЫЛКА Справочник.РабочиеГруппы
			|	ИЛИ АдреснаяКнигаРодители.Объект ССЫЛКА Справочник.Мероприятия
			|	ИЛИ АдреснаяКнигаРодители.Объект ССЫЛКА Справочник.Проекты
			|	ИЛИ АдреснаяКнигаРодители.Объект ССЫЛКА Справочник.ГруппыКонтактовПользователей)
			|	И АдреснаяКнигаПодчиненные.ОтображатьВАдреснойКниге = ИСТИНА
			|	И АдреснаяКнигаПодчиненные.РодительОбъекта <> НЕОПРЕДЕЛЕНО
			|	И АдреснаяКнигаПодчиненные.Родитель <> ЗНАЧЕНИЕ(Справочник.АдреснаяКнига.ПустаяСсылка)";
	...
	Запрос.Текст = 
		"ВЫБРАТЬ ПЕРВЫЕ 2000
		|	АдреснаяКнигаПодчиненные.Ссылка,
		|	АдреснаяКнигаПодчиненные.Объект
		|ИЗ
		|	Справочник.АдреснаяКнига КАК АдреснаяКнигаПодчиненные
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.АдреснаяКнига КАК АдреснаяКнигаРодители
		|		ПО АдреснаяКнигаПодчиненные.Родитель = АдреснаяКнигаРодители.Ссылка
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Справочники.АдреснаяКнига.УстановитьПризнакОтображенияОбъектаВАдреснойКниге(
				ОбъектВАдреснойКниге, Выборка.Объект);
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ПерейтиНаВерсию_2_1_29_8 не удалось обработать некоторые записи. Пропущено: %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ПерейтиНаВерсию_2_1_29_9(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст =  
			"ВЫБРАТЬ
			|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ ПоискВАдреснойКниге.ОбъектПоиска) КАК ВсегоОбъектов
			|ИЗ
			|	Справочник.Пользователи КАК Пользователи
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ПоискВАдреснойКниге КАК ПоискВАдреснойКниге
			|		ПО Пользователи.Ссылка = ПоискВАдреснойКниге.ОбъектПоиска
			|ГДЕ
			|	(Пользователи.Недействителен = ИСТИНА
			|	ИЛИ Пользователи.ПометкаУдаления = ИСТИНА
			|	ИЛИ Пользователи.Служебный = ИСТИНА)
			|	И ПоискВАдреснойКниге.ИспользоватьВПоиске = ИСТИНА
			|
			|ОБЪЕДИНИТЬ ВСЕ
			|
			|ВЫБРАТЬ
			|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ ПоискВАдреснойКниге.ОбъектПоиска)
			|ИЗ
			|	Справочник.РолиИсполнителей КАК РолиИсполнителей
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ПоискВАдреснойКниге КАК ПоискВАдреснойКниге
			|		ПО РолиИсполнителей.Ссылка = ПоискВАдреснойКниге.ОбъектПоиска
			|ГДЕ
			|	РолиИсполнителей.ПометкаУдаления = ИСТИНА
			|	И ПоискВАдреснойКниге.ИспользоватьВПоиске = ИСТИНА
			|
			|ОБЪЕДИНИТЬ ВСЕ
			|
			...
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ПоискВАдреснойКниге КАК ПоискВАдреснойКниге
			|		ПО КонтактныеЛица.Ссылка = ПоискВАдреснойКниге.ОбъектПоиска
			|ГДЕ
	...
	Запрос.Текст =
		"ВЫБРАТЬ РАЗЛИЧНЫЕ ПЕРВЫЕ 1000
		|	ПоискВАдреснойКниге.ОбъектПоиска
		|ИЗ
		|	Справочник.Пользователи КАК Пользователи
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ПоискВАдреснойКниге КАК ПоискВАдреснойКниге
		|		ПО Пользователи.Ссылка = ПоискВАдреснойКниге.ОбъектПоиска
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			ЗаблокироватьДанныеДляРедактирования(Выборка.ОбъектПоиска);
			РегистрыСведений.ПоискВАдреснойКниге.ОбновитьДоступностьВПоиске(
				Выборка.ОбъектПоиска.ПолучитьОбъект());
			РазблокироватьДанныеДляРедактирования(Выборка.ОбъектПоиска);
			ЗафиксироватьТранзакцию();
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ПерейтиНаВерсию_2_1_29_9 не удалось обработать некоторые записи. Пропущено: %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ПерейтиНаВерсию_2_1_29_10(Параметры) Экспорт
	
	Запрос = Новый Запрос;	
	Запрос.Текст =
		"ВЫБРАТЬ
		|	Пользователи.Ссылка КАК Ссылка,
		|	Пользователи.ФизЛицо.ФайлФотографии КАК ФизЛицоФайлФотографии,
	...
	Пока Выборка.Следующий() Цикл
		...
		ЕстьКартинкаУПользователя = Ложь;
		Попытка
			ДвоичныеДанные = Выборка.Фотография.Получить();
			ЕстьКартинкаУПользователя = ЗначениеЗаполнено(ДвоичныеДанные);
		Исключение
			ЕстьКартинкаУПользователя = Ложь;
		КонецПопытки;

		// Данные уже загружены
		Если ЕстьКартинкаУПользователя Тогда
			Продолжить;
		КонецЕсли;
		
		ЕстьКартинка = Ложь;
		Попытка
			ДвоичныеДанные = Выборка.ФизЛицоФайлФотографии.Получить();
			ЕстьКартинка = ЗначениеЗаполнено(ДвоичныеДанные);
		Исключение
			ЕстьКартинка = Ложь;
		КонецПопытки;
		
		// Картинка не использовалась
		...
		Попытка
			...
			АдресФотографии = ПоместитьВоВременноеХранилище(ДвоичныеДанные, УИД);
			ПользовательОбъект = Выборка.Ссылка.ПолучитьОбъект();
			ПользовательОбъект.Фотография = Новый ХранилищеЗначения(ПолучитьИзВременногоХранилища(АдресФотографии));
	...
	Если ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ПерейтиНаВерсию_2_1_29_10 не удалось обработать некоторых пользователей. Пропущено: %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
	
	// Всегда выполняется в один проход
	Параметры.ОбработкаЗавершена = Истина;
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_12() Экспорт
	
	РегистрыСведений.СоставСубъектовПравДоступа.ОбновитьВсеДанные(Истина, Ложь);	
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_13() Экспорт
	
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЧтениеДанныхСервисаDSS", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_29_17() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2022Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_30_4() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_31_1() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_31_2() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_32_4() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2023Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_32_5() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_32_6() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемыДокументооборота.МЭДО") Тогда 
		...
		Менеджер = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени("Справочник.ВидыДокументовМЭДО");
		Менеджер.ПервоначальноеЗаполнение();
		
		Менеджер = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени("Справочник.ПричиныОтказаВРегистрацииМЭДО");
		Менеджер.ПервоначальноеЗаполнение();
		
		Менеджер = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени("Справочник.МестаСоставленияДокументовМЭДО");
		Менеджер.ПервоначальноеЗаполнение();
	КонецЕсли;
...
Функция ВыполнитьНачальноеЗаполнениеСпискаКлючевыхОпераций() Экспорт
	...
	Если ОбщегоНазначения.РазделениеВключено() И Не ОбщегоНазначения.РазделениеВыключено() Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Процедура ПеренестиНастройкиИзГруппДоступаВРазрешенияИРабочиеГруппы() Экспорт
	...
	Пока ВыборкаОбъектМетаданных.Следующий() Цикл
		...
		Пока ВыборкаГруппаДоступа.Следующий() Цикл
			...
			ОбработанныеВидыДоступа = Новый Массив;
			...
			Пока ВыборкаВидДоступа.Следующий() Цикл
				...
				ОбработанныеВидыДоступа.Добавить(ВыборкаВидДоступа.ВидДоступа);
				
			КонецЦикла;
			
			Для Каждого АктуальныйВидДоступа Из АктуальныеВидыДоступа Цикл
				Если ОбработанныеВидыДоступа.Найти(АктуальныйВидДоступа.Значение) = Неопределено Тогда
					
					// Добавим удаленные из профиля ГД виды доступа как те, по которым нет ограничений
					НоваяСтрока = ДоступныеЗначения.Добавить();
					НоваяСтрока.ВидДоступа = АктуальныйВидДоступа.Значение;
					НоваяСтрока.ЗначениеДоступа = АктуальныйВидДоступа.Значение;
