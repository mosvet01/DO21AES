...
Процедура ОтправитьПисьмоИзФормы1СОтчетность_Завершение(Результат, ДополнительныеПараметры) Экспорт
	
	РегламентированнаяОтчетностьКлиент.ВернутьОшибку(ДополнительныеПараметры.ОповещениеОЗавершении, Результат, "");
