...
Функция ПорядокУдаленияЭлемента(ТипЭлемента) Экспорт
	...
	// Удалению вида может препятствовать, например, дескриптор шаблона со ссылкой на вид.
	// Пока шаблон не удален, такой Д считается используемым, поэтому вид не будет удален.
	Если ТипЭлемента = "Справочник.ВидыВнутреннихДокументов"
		Или ТипЭлемента = "Справочник.ВидыВходящихДокументов"
		Или ТипЭлемента = "Справочник.ВидыИсходящихДокументов" Тогда
		Результат = 1;
	// Удаление набора доп. реквизитов может спровоцировать преждевременное удаление вида документов.
	ИначеЕсли ТипЭлемента = "Справочник.НаборыДополнительныхРеквизитовИСведений" Тогда
		Результат = 2;
	ИначеЕсли ТипЭлемента = "Справочник.ДескрипторыДоступаОбъектов"
