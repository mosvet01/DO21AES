...
Процедура БронированиеПриЗаписиПредмета(Источник, Отказ) Экспорт
	...
	// Если мероприятие отменено, то бронировать помещение не нужно.
	...
	ЗабронироватьПомещениеДляМероприятия(Источник);
		...
		Для Каждого ЗаписьСостояния Из Источник Цикл
			...
			ИначеЕсли ЗаписьСостояния.Состояние = Перечисления.СостоянияМероприятий.МероприятиеВСтадииПодготовки
				...
				Если Не МероприятиеПомеченоНаУдаление Тогда
					...
					ЗабронироватьПомещениеДляМероприятия(МероприятиеОбъект);
...
// Бронирует помещение для мероприятия.
// 
// Параметры:
//  МероприятиеОбъект - СправочникОбъект.Мероприятия.
//
Процедура ЗабронироватьПомещениеДляМероприятия(МероприятиеОбъект)
	...
	Пользователь = Метаданные.Документы.Бронь.Реквизиты.Пользователь.Тип.ПривестиЗначение(
		МероприятиеОбъект.Организатор);
	Если Не ЗначениеЗаполнено(Пользователь) Тогда
		Пользователь = Метаданные.Документы.Бронь.Реквизиты.Пользователь.Тип.ПривестиЗначение(
			МероприятиеОбъект.Куратор);
	КонецЕсли;
	Если Не ЗначениеЗаполнено(Пользователь) Тогда
