...
//    * СкрыватьСостояниеПриОтсутствииЭДО - Булево - признак отображения группы состояния ЭДО при отсутствии электронных документов по объекту учета.
//    * МестоРазмещенияКоманд - ЭлементФормы - элемент формы "группа", в котором должны отображаться команды ЭДО, необязательный параметр.
//    * Направление - ПеречислениеСсылка.НаправленияЭДО - указывает направление электронного документа для документа ИБ.
//
...
Функция ДанныеДляЗаполненияСтатусовЭлектронныхДокументов(ПараметрыОбъектовУчета, УчитыватьВсеАктуальные)
	...
	Запрос.Текст =
		...
		|	ЕСТЬNULL(ЕСТЬNULL(НастройкиОтправкиДокументовПоВидам.Договор,
		|		НастройкиОтправкиДокументовПоВидамПустойДоговор.Договор), ПараметрыОбъектовУчета.ДоговорКонтрагента),
