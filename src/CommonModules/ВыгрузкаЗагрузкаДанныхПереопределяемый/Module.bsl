...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	...
	Для Каждого Объект Из Метаданные.Подсистемы.НастройкаИАдминистрирование.Подсистемы.МиграцияДанныхИзВнешнихСистем.Состав Цикл
		Типы.Добавить(Объект);
	КонецЦикла;
	
	Для Каждого Объект Из Метаданные.Подсистемы.НастройкаИАдминистрирование.Подсистемы.ОтметкиВремени.Состав Цикл
		Типы.Добавить(Объект);
	КонецЦикла;
	
	Для Каждого Объект Из Метаданные.Подсистемы.СтандартныеПодсистемы.Подсистемы.ОценкаПроизводительности.Состав Цикл
		Если Метаданные.РегистрыСведений.Содержит(Объект) Тогда
			Типы.Добавить(Объект);
		КонецЕсли;
	КонецЦикла;
	...
	Типы.Добавить(Метаданные.РегистрыСведений.ЗамерыВремени);
	Типы.Добавить(Метаданные.РегистрыСведений.ЗамерыВремениТехнологические);
	Типы.Добавить(Метаданные.РегистрыСведений.УдалитьЗамерыВремени);
	Типы.Добавить(Метаданные.РегистрыСведений.УдалитьЗамерыВремени2);
	Типы.Добавить(Метаданные.РегистрыСведений.УдалитьЗамерыВремени3);
	Типы.Добавить(Метаданные.РегистрыСведений.УдалитьЗамерыВремениТехнологические);
	Типы.Добавить(Метаданные.РегистрыСведений.ЗамерыМетрик);
