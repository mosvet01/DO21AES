...
Функция СвойстваПодписи(ДвоичныеДанныеПодписи, СвойстваСертификата, Комментарий,
			АвторизованныйПользователь, ИмяФайлаПодписи = "",
			ПараметрыПодписи = Неопределено, Доверенность = Неопределено) Экспорт
	...
	СвойстваПодписи.Вставить("Доверенность", Доверенность);
