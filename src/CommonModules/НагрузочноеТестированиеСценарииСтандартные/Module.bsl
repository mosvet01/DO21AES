...
Функция СозданиеВнутреннегоДокумента(РеквизитыДокумента) Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Заголовок*", СтрШаблон(НСтр("ru = 'Внутренний документ %1'"), Строка(ИдентификаторДокумента)));
...
Функция СозданиеВходящегоДокумента(РеквизитыДокумента) Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Заголовок*", СтрШаблон(НСтр("ru = 'Входящий документ %1'"), Строка(ИдентификаторДокумента)));
	Реквизиты.Вставить("Объект.ВидДокумента*", РеквизитыДокумента.ВидДокумента);
...
Функция СозданиеИсходящегоДокумента(РеквизитыДокумента) Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Заголовок*", СтрШаблон(НСтр("ru = 'Исходящий документ %1'"), Строка(ИдентификаторДокумента)));
	Реквизиты.Вставить("Объект.ВидДокумента*", РеквизитыДокумента.ВидДокумента);
	Реквизиты.Вставить("Объект.Организация*", РеквизитыДокумента.Организация);
...
Функция СозданиеПроцессаИсполнение() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Исполнение %1'"), Строка(ИдентификаторПроцесса)));
...
Функция СозданиеПроцессаОзнакомление() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Ознакомление %1'"), Строка(ИдентификаторПроцесса)));
...
Функция СозданиеПроцессаПоручение() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Поручение %1'"), Строка(ИдентификаторПроцесса)));
...
Функция СозданиеПроцессаПриглашение() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Приглашение %1'"), Строка(ИдентификаторПроцесса)));
...
Функция СозданиеПроцессаРассмотрение() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Рассмотрение %1'"), Строка(ИдентификаторПроцесса)));
	Реквизиты.Вставить("Объект.Исполнитель", Исполнитель);
...
Функция СозданиеПроцессаРегистрация() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Регистрация %1'"), Строка(ИдентификаторПроцесса)));
	Реквизиты.Вставить("Объект.Исполнитель", Исполнитель);
...
Функция СозданиеПроцессаСогласование() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Согласование %1'"), Строка(ИдентификаторПроцесса)));
...
Функция СозданиеПроцессаУтверждение() Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("Объект.Наименование*", СтрШаблон(НСтр("ru = 'Утверждение %1'"), Строка(ИдентификаторПроцесса)));
	Реквизиты.Вставить("Объект.Исполнитель", Исполнитель);
