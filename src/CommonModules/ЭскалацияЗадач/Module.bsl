...
Функция ДоступныеАвтоподстановки() Экспорт
	...
	ДоступныеФункции.Добавить(НСтр("ru = 'Автор процесса'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Непосредственный руководитель автора процесса'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Автор документа'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Непосредственный руководитель автора документа'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Ответственный за документ'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Непосредственный руководитель ответственного за документ'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Руководитель организации'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Адресат документа'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Председатель мероприятия'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Секретарь мероприятия'"));
	ДоступныеФункции.Добавить(НСтр("ru = 'Непосредственный руководитель исполнителя'"));
	...
	Попытка
		...
		Если Не ЭскалацияЗадачПереопределяемый.ПрименитьПравилоЭскалации(Задача, ПравилоЭскалации, ИнформацияОбЭскалации) Тогда
			...
			Если ПравилоЭскалации.Действие = Перечисления.ДействияПравилЭскалацииЗадач.Перенаправление Тогда
				...
				КонецЕсли;
				ИнфоОПеренаправлении.Комментарий = НСтр("ru = 'Перенаправлено автоматически'");
...
Функция АвтоподстановкиПоПредмету()
	...
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Автор документа'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Непосредственный руководитель автора документа'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Ответственный за документ'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Непосредственный руководитель ответственного за документ'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Руководитель организации'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Адресат документа'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Председатель мероприятия'"));
	АвтоподстановкиПоПредмету.Добавить(НСтр("ru = 'Секретарь мероприятия'"));
...
Функция АвтоподстановкиПоЗадаче()
	...
	АвтоподстановкиПоЗадаче.Добавить(НСтр("ru = 'Непосредственный руководитель исполнителя'"));
