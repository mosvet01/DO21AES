...
Функция НачатьЗагрузкуДанныхТекущейОбластиИзАрхива(Знач ДанныеФайла, Знач ПараметрыЗагрузки, 
	...
	Если ТипЗнч(ДанныеФайла) = Тип("Структура")
		...
		АрхивКопии = РаботаВМоделиСервиса.ПрочитатьАрхив(ДанныеФайла.ИдентификаторФайлаИсточника);
		ДанныеФайла = РаботаВМоделиСервиса.ПрочитатьВложенныйНесжатыйАрхив(АрхивКопии,
