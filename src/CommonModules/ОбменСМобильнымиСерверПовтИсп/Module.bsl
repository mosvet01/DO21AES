...
Функция ПолучитьСсылкуПоТипу(ТипЗначения, СтрокаИдентификатора) Экспорт
	...
	ИначеЕсли СтрСравнить(ТипЗначения, МП_СлужебныйПовтИсп.ТипМоеОтсутствие()) = 0 Тогда
		Возврат Документы.Отсутствие.ПолучитьСсылку(Идентификатор);
		
	ИначеЕсли СтрСравнить(ТипЗначения, МП_СлужебныйПовтИсп.ТипМоеСамочувствие()) = 0 Тогда
		Возврат Документы.СамочувствиеСотрудника.ПолучитьСсылку(Идентификатор);
