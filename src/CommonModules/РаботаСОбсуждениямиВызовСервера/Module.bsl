...
//
Функция ПредставлениеСообщенияHTML(Знач Сообщение, Знач ФормироватьШапку, Знач УникальныйИдентификаторФормы) Экспорт
	
	Возврат РаботаСОбсуждениями.ПредставлениеСообщенияHTML(Сообщение, ФормироватьШапку, УникальныйИдентификаторФормы);
