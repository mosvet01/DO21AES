...
//                          загрузки данных. Если передан УникальныйИдентификатор, то это идентификатор
//                          фонового задания.
//
// Возвращаемое значение:
...
Процедура ПриСозданииНаСервере(Форма, КонтрагентОбъект, Контрагент, ВидКонтрагента, ПараметрыОтображения) Экспорт
	...
	// Метод ПолучитьРеквизиты() не используется осознано, т.к. выполнение
	// настройки через Попытка/Исключение работает быстрее.
...
Функция ИдентификаторУслугиВебКарточкиПоКомпаниям()
