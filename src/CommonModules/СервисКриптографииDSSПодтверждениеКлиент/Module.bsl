...
Функция ПодтверждениеПриИзменении(КонтекстФормы, ПолеФормы, ОписаниеДанных, ЗначениеПароля) Экспорт
	...
	ИначеЕсли ИмяЭлемента = "Сертификат" ИЛИ ИмяЭлемента = "СертификатСписокВыбора"  Тогда
...
Функция ПолучитьПредставлениеДанных(ТекущийЭлементНабораДанных, ОписаниеДанных)
	...
	Если ТекущийЭлементНабораДанных <> Неопределено Тогда
		Если ТекущийЭлементНабораДанных.Свойство("Объект")
			И ТипЗнч(ТекущийЭлементНабораДанных.Объект) <> Тип("ОписаниеОповещения") Тогда
...
Процедура СформироватьПодсказкуСпособовВыбора(КонтекстФормы, ИмяЭлемента = "ПодтверждениеСпособПодтверждения")
	...
	// Не нужно формировать подсказку на мобильном клиенте.
	#Если МобильныйКлиент Тогда
		Возврат;
	#КонецЕсли
...
Процедура УправлениеЭлементамиДляПодписания(ЭлементыФормы, НеНачалось, НуженПинКод, ПроверенПинКод = Ложь, СтандартныйВид = Ложь)
	...
	#Если Не МобильныйКлиент Тогда
		УстановитьСвойствоЭлемента(ЭлементыФормы, "ПарольЗаголовок", "Заголовок", 
			?(НуженПинКод И НЕ СтандартныйВид, 
			НСтр("ru = 'Введите пин-код сертификата'", КодЯзыка),
			НСтр("ru = 'Введите пароль к сертификату'", КодЯзыка)));
	#КонецЕсли
	...
	#Если МобильныйКлиент Тогда
		УстановитьСвойствоЭлемента(ЭлементыФормы, "ЗапомнитьПароль", "ОтображениеПодсказки", ОтображениеПодсказки.Нет);
		УстановитьСвойствоЭлемента(ЭлементыФормы, "ЗапомнитьПароль", "ПоложениеЗаголовка", ПоложениеЗаголовкаЭлементаФормы.Лево);
		УстановитьСвойствоЭлемента(ЭлементыФормы, "ЗапомнитьПароль", "Заголовок", НСтр("ru = 'Запомнить'", КодЯзыка));
		УстановитьСвойствоЭлемента(ЭлементыФормы, "Пароль", "ПоложениеЗаголовка", ПоложениеЗаголовкаЭлементаФормы.Лево);
		УстановитьСвойствоЭлемента(ЭлементыФормы, "Пароль", "ГоризонтальноеПоложение", ГоризонтальноеПоложениеЭлемента.Право);
		УстановитьСвойствоЭлемента(ЭлементыФормы, "Пароль", "РастягиватьПоГоризонтали", Истина);
		УстановитьСвойствоЭлемента(ЭлементыФормы, "ГруппаПароль", "Группировка", ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда);
	#КонецЕсли
...
Процедура УправлениеЭлементамиДляРасшифрования(ЭлементыФормы, НеНачалось, НуженПинКод, ПроверенПинКод = Ложь, СтандартныйВид = Ложь)
	...
	УстановитьСвойствоЭлемента(ЭлементыФормы, "ПарольЗаголовок", "Заголовок", ?(НуженПинКод И НЕ СтандартныйВид, НСтр("ru = 'Введите пин-код сертификата'", КодЯзыка), НСтр("ru = 'Введите пароль к сертификату'", КодЯзыка)));
