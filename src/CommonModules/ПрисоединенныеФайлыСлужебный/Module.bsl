...
Функция ПолучитьИмяФайлаСПутемКДвоичнымДанным(Знач ПрисоединенныйФайл, ПустойПутьДляПустыхДанных = Ложь)
	...
	ВызватьИсключение "Не поддерживаемый код";
...
Процедура ПриОтправкеФайла(ЭлементДанных,
	...
	ИначеЕсли ТипЗнч(ЭлементДанных) = Тип("РегистрСведенийНаборЗаписей.НаличиеФайлов") Тогда
...
Процедура ПриДобавленииИсключенийПоискаСсылок(Массив) Экспорт
	...
	Массив.Добавить(Метаданные.РегистрыСведений.НаличиеФайлов.ПолноеИмя());
...
// из регистра НаличиеФайлов увеличивает его значение
