...
Процедура ПроверитьКорректностьЗаполненияСроковПередСтартом(
	...
	ЗаголовокВопроса = НСтр("ru = 'Запуск процесса'");
...
Функция ТекстыВопросовДляПроверкиКорректностиЗаполненияСроков(Процесс)
	...
	ТекстыВопросов.ПриНеОпределенномСрокеПроцесса =
			НСтр("ru = 'Срок процесса не определен. Запустить процесс?'");
	...
	Если ЭтоСоставнойПроцесс Тогда
		ТекстыВопросов.ПриНеЗаполненныхСроках =
			НСтр("ru = 'Сроки некоторых действий не определены. Запустить процесс?'");
		ТекстыВопросов.ПриИстекшихСрока =
			НСтр("ru = 'Сроки некоторых действий уже истекли. Запустить процесс?'");
	Иначе
		ТекстыВопросов.ПриНеЗаполненныхСроках =
			НСтр("ru = 'Некоторые сроки не указаны. Запустить процесс?'");
		ТекстыВопросов.ПриИстекшихСрока =
			НСтр("ru = 'Некоторые сроки процесса уже истекли. Запустить процесс?'");
	КонецЕсли;
