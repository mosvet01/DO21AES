...
Процедура ВыгрузитьВXMLНастройкиСинхронизации(ЗаписьXML, ВерсияКлиента, 
	...
	Настройка = Запись.Настройка;

	Если ВерсияКлиента >= "213" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СинхронизацияПапокПисем Тогда

		ВыгрузитьВXMLНастройкуСинхронизацииПапокПисем(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "213" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.ШаблоныТекстовПисем Тогда

		ВыгрузитьВXMLНастройкиШаблоновПисем(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "213" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.МаксимальныйРазмерФайла Тогда

		ВыгрузитьВXMLНастройкуМаксРазмераФайла(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "213" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СрокУстареванияДанных Тогда

		ВыгрузитьВXMLНастройкуСрокаУстаревания(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "214" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СинхронизироватьПочту Тогда

		ВыгрузитьВXMLНастройкуСинхронизацииПочты(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "214" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СинхронизироватьЗадачи Тогда

		ВыгрузитьВXMLНастройкуСинхронизацииЗадач(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "214" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СинхронизироватьКалендарь Тогда

		ВыгрузитьВXMLНастройкуСинхронизацииКалендаря(ЗаписьXML, ВерсияКлиента, 
			ПараметрыСинхронизации, Запись);

	ИначеЕсли ВерсияКлиента >= "214" 
		И Настройка = Перечисления.ВидыНастроекОбменаСМобильнымКлиентом.СинхронизироватьКонтроль Тогда
