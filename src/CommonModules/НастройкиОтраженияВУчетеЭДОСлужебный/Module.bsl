...
Функция СохранитьНастройкиОтраженияВУчете(Настройки, Получатель, Отправитель,
	ИдентификаторПолучателя, ИдентификаторОтправителя, НастройкиДО = Неопределено) Экспорт
	
	НастройкиДО.Колонки.Добавить("Организация");
	НастройкиДО.ЗаполнитьЗначения(Получатель, "Организация");
	
	НастройкиДО.Колонки.Добавить("Контрагент");
	НастройкиДО.ЗаполнитьЗначения(Отправитель, "Контрагент");
	...
	Попытка
		...
		НаборЗаписейДО.Загрузить(НастройкиДО);
