...
Функция ПолучитьТаблицуСобытий(
	...
	Запрос.Текст = 
		...
		|			И (НастройкаЦвета.Пользователь = ЗаписиРабочегоКалендаря.Пользователь)
		...
		|			И (ОтработаныЗаписи.Пользователь =ЗаписиРабочегоКалендаря.Пользователь)
