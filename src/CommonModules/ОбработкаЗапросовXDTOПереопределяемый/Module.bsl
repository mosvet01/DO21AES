...
//
// Параметры:
//   СсылкаНаДокумент - СправочникСсылка.ВнутренниеДокументы,
//                      СправочникСсылка.ВходящиеДокументы,
//                      СправочникСсылка.ИсходящиеДокументы - проверяемый документ.
//
// Возвращаемое значение:
...
Функция ПолучитьСостояниеДокумента(СсылкаНаДокумент) Экспорт
	...
	МассивСостояний = Делопроизводство.ПолучитьВсеСостоянияДокумента(СсылкаНаДокумент).ВыгрузитьКолонку("Состояние");
