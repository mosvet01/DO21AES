...
Процедура ОбработкаВыбораЭлемента(Планировщик, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ЗначениеЭлемента.ВидЭлемента =
		...
		ОбработкаВыбораПовторяющейсяБрони(
			ЗначениеЭлемента.Ссылка,
			РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ВыделенныйЭлемент.Начало));
	КонецЕсли;
...
//
Процедура СоздатьИЗаписатьБронь(Помещение, ДатаНачала, ДатаОкончания, ВесьДень, Комментарий) Экспорт
	
	Бронь = Новый Структура("Помещение, ДатаНачала, ДатаОкончания, ВесьДень, Комментарий");
	Бронь.Помещение = Помещение;
	Бронь.ВесьДень = ВесьДень;
	Бронь.ДатаНачала = ?(ВесьДень, Бронь.ДатаНачала, РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ДатаНачала));
	Бронь.ДатаОкончания = ?(ВесьДень, Бронь.ДатаОкончания, РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ДатаОкончания));
...
Процедура СоздатьБронь(Помещение, ДатаНачала, ДатаОкончания, ВесьДень = Ложь, Комментарий = "", КоличествоЧеловек = 0) Экспорт
	...
	СтруктураОснование.ДатаНачала = ?(ВесьДень, ДатаНачала, РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ДатаНачала));
	СтруктураОснование.ДатаОкончания = ?(ВесьДень, ДатаОкончания, РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ДатаОкончания));
...
Процедура ОбработкаСозданиеЭлемента(Планировщик)
	...
	СоздатьИЗаписатьБронь(
		...
		ВыделенныйЭлемент.Значение.Комментарий);
...
Функция ПолучитьПовторяющиесяБрониВВыделеннойОбласти(Планировщик) Экспорт
	...
	Для Каждого ВыделенныйЭлемент Из Планировщик.ВыделенныеЭлементы Цикл
		...
		ПовторяющаясяБронь.ДатаИсключения = РаботаСЧасовымиПоясамиКлиент.ПривестиКВремениСеанса(ВыделенныйЭлемент.Начало);
