...
&НаКлиенте
Перем ОтключитьОбработкуАктивизацииСтрокиГруппировки;
...
Процедура АвторыПриАктивизацииСтроки(Элемент)
	...
	Если ОтключитьОбработкуАктивизацииСтрокиГруппировки = Истина Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОбновитьСписокЗадачМне()
	...
	ОтключитьОбработкуАктивизацииСтрокиГруппировки = Истина;
	...
	ОтключитьОбработкуАктивизацииСтрокиГруппировки = Ложь;
