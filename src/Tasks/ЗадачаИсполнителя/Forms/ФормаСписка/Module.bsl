...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.ГруппаОтбор.Заголовок = НСтр("ru = 'Фильтры'");
	Элементы.ГруппаОтбор.ЦветФона = ЦветаСтиля.МК_ЦветФонаГруппы;
	Элементы.ГруппаОтбор.РастягиватьПоГоризонтали = Истина;
	Элементы.МК_ОчиститьБыстрыеОтборы.Видимость = Истина;

	Элементы.ПоказыватьЗадачи.РастягиватьПоГоризонтали = Истина;
	Элементы.ПоАвтору.РастягиватьПоГоризонтали = Истина;
	Элементы.ПоИсполнителю.РастягиватьПоГоризонтали = Истина;
	Элементы.ПоПроекту.РастягиватьПоГоризонтали = Истина;
	Элементы.ТочкаМаршрута.РастягиватьПоГоризонтали = Истина;
	...
	Элементы.Переместить(Элементы.Группа1, Элементы.ГруппаКартинки);
	
	Элементы.Переместить(Элементы.ГруппаИсполнитель, Элементы.ГруппаНаименованиеИсполнитель);
	Элементы.Переместить(Элементы.Дата, Элементы.ГруппаДатаСрок);
	Элементы.Переместить(Элементы.СрокИсполнения, Элементы.ГруппаДатаСрок);

	Элементы.Исполнитель.Высота = 1;
	Элементы.Исполнитель.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
	Элементы.Исполнитель.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
	
	Элементы.Дата.Ширина = 5;
	Элементы.Дата.Высота = 2;
	Элементы.СрокИсполнения.Ширина = 5;
	Элементы.СрокИсполнения.Высота = 2;
	...
	Элементы.Переместить(Элементы.ОткрытьБизнесПроцесс, Элементы.Список.КонтекстноеМеню);
	Элементы.Переместить(Элементы.СправочникКонтрольКонтроль, Элементы.Список.КонтекстноеМеню);
	Элементы.Переместить(Элементы.ЗадачаЗадачаИсполнителяЗадатьВопросАвтору, Элементы.Список.КонтекстноеМеню);
	Элементы.Переместить(Элементы.ГруппаСоздатьНаОсновании, Элементы.Список.КонтекстноеМеню);
	Элементы.Переместить(Элементы.СоздатьПодзадачу, Элементы.Список.КонтекстноеМеню);
...
&НаКлиенте
Процедура МК_ОчиститьБыстрыеОтборы(Команда)
...
Процедура ОчиститьБыстрыеОтборыНаСервере()
	...
	ПоказыватьЗадачи = 0;
	ПоАвтору = Справочники.Пользователи.ПустаяСсылка();
	ПоИсполнителю = Справочники.Пользователи.ПустаяСсылка();
	ПоПроекту = Справочники.Проекты.ПустаяСсылка();
