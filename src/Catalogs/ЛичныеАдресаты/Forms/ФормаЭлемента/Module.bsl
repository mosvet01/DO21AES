...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Элементы.Фотография.Гиперссылка = Истина;
	Иначе
...
Процедура АдресКартинкиНажатие(Элемент, СтандартнаяОбработка)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("АдресКартинкиНажатиеПослеВыбора", ЭтотОбъект);
	
	Список = Новый СписокЗначений();
	Список.Добавить("Заменить", "Заменить");
	Список.Добавить("Очистить", "Очистить");
...
&НаКлиенте
Процедура АдресКартинкиНажатиеПослеВыбора(ВыбранноеЗначение, Параметр) Экспорт
	
	Если ВыбранноеЗначение.Значение = "Очистить" Тогда
		ОчиститьИзображениеРеализация();
		Модифицированность = Истина;
		
	ИначеЕсли ВыбранноеЗначение.Значение = "Заменить" Тогда
	  	ОчиститьИзображениеРеализация();
		ДобавитьИзображениеНаКлиенте();	
	  	Модифицированность = Истина;
	КонецЕсли;
...
&НаКлиенте
Процедура ОчиститьИзображениеРеализация()
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Перемщаем группу фото и ФИО в группу для горизонтальной ориентации.
	Элементы.ГруппаНаименованиеИФотоМК.Видимость = Истина; 
	Элементы.Переместить(Элементы.Наименование,Элементы.ГруппаНаименованиеИФотоМК, Элементы.ГруппаНаименованиеИФотоМК);
	Элементы.Переместить(Элементы.ГруппаФото, Элементы.ГруппаНаименованиеИФотоМК, Элементы.ГруппаНаименованиеИФотоМК);
	Элементы.ГруппаФото.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Центр;
	
	Если Не ЕстьКартинка Тогда
		Элементы.Фотография.Видимость = Ложь;
		
		// Создание гиперссылки для добавления фото.
		ЭлементДобавитьФотоМК = Элементы.Добавить("ДобавитьФотоМК", Тип("ДекорацияФормы"), Элементы.ГруппаНаименованиеИФотоМК);
		ЭлементДобавитьФотоМК.Вид = ВидДекорацииФормы.Надпись;
		ЭлементДобавитьФотоМК.Гиперссылка = Истина;
		ЭлементДобавитьФотоМК.Заголовок = "Добавить фото";
		ЭлементДобавитьФотоМК.УстановитьДействие("Нажатие","ДобавитьИзображениеНаКлиенте");
		
		Элементы.Переместить(ЭлементДобавитьФотоМК, Элементы.ГруппаВсеПоля, Элементы.ГруппаВсеПоля);
	КонецЕсли;
