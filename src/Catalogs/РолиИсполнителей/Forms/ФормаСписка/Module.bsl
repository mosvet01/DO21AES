...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.РолиИИсполнители.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяЕслиВозможно;
	
	Элементы.Переместить(Элементы.ПоказыватьРолиПомеченныеНаУдаление, ЭтаФорма.КоманднаяПанель, ЭтаФорма.КоманднаяПанель);
	Элементы.Переместить(Элементы.ПоказыватьНедействительныхИсполнителей, ЭтаФорма.КоманднаяПанель, ЭтаФорма.КоманднаяПанель);
	
	Элементы.КомПанельОбщая.Видимость = Ложь;
