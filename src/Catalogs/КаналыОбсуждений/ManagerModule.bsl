...
// Возвращает ссылку на канал по ссылке на его пользователя.
// 
Функция КаналПоПользователю(ПользовательСсылка) Экспорт
...
Функция ПолучитьАдресФото(Ссылка, УникальныйИдентификатор, ЕстьКартинка) Экспорт
	...
	Возврат РаботаСФотографиями.ПолучитьНавигационнуюСсылкуРеквизита(
		Ссылка, УникальныйИдентификатор, ЕстьКартинка);
	
КонецФункции

// Возвращает двоичные данные фото.
//
Функция ПолучитьДвоичныеДанныеФото(Ссылка) Экспорт
	
	ДвоичныеДанные = РаботаСФотографиями.ПолучитьДвоичныеДанныеРеквизита(Ссылка, "ФайлФотографии");
