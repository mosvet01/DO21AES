...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ДокументДокументооборота =
		ОтчетностьВКонтролирующиеОрганы.ИсходящийДокументПоЭлектронномуДокументуКО(ТекущийОбъект.Ссылка);
...
&НаКлиенте
Процедура ПерезаполнитьИсходящийДокумент(Команда)
...
&НаКлиенте
Процедура ПодобратьФайлыИзДокументаДО(Команда)
	
	Если Параметры.Ключ.Пустая() Тогда
		Если Не ЗаписатьОбъект("ПодобратьФайлыИзДокументаДО") Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаписатьОбъектЗавершение(РезультатПроверки, ДополнительныеПараметры) Экспорт
	...
	Если Успешно И ЗначениеЗаполнено(ДействиеПослеЗаписи) Тогда
		...
		ИначеЕсли ДействиеПослеЗаписи = "Печать" Тогда
			Печать(Неопределено);
		ИначеЕсли ДействиеПослеЗаписи = "ПодобратьФайлыИзДокументаДО" Тогда
			ПодобратьФайлыИзДокументаДО(Неопределено);
		КонецЕсли;
...
Процедура УстановитьВидимостьКомандДО(Форма)
	...
	Форма.Элементы.СоздатьИсходящийДокументДокументооборота.Видимость = Не ЗначениеЗаполнено(Форма.ДокументДокументооборота);
	Форма.Элементы.ПерезаполнитьИсходящийДокумент.Видимость = ЗначениеЗаполнено(Форма.ДокументДокументооборота);
