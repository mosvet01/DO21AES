...
Процедура ЗаполнитьШаблонПоУмолчанию() Экспорт
	...
	Если Ссылка <> Справочники.ШаблоныУтверждения.ПоУмолчанию Тогда
	...
	ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.ПустаяСсылка();
	...
	ИсходныйШаблон = Справочники.ШаблоныУтверждения.ПустаяСсылка();
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Ссылка <> Справочники.ШаблоныУтверждения.ПоУмолчанию Тогда
		...
		ПроверяемыеРеквизиты.Добавить("ВидПроцесса");
	КонецЕсли;
