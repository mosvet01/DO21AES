...
Процедура ОбновитьСогласноПометкеУдаленияИНедействительности()
	...
	Если Объект.ПометкаУдаления И Объект.Недействительна Тогда
		ТекстСостояния = НСтр("ru = 'Помечена на удаление и недействительна. Участники не редактируются.'");
	ИначеЕсли Объект.ПометкаУдаления Тогда
		ТекстСостояния = НСтр("ru = 'Помечена на удаление. Состав участников не редактируется.'");
	ИначеЕсли Объект.Недействительна Тогда
		ТекстСостояния = НСтр("ru = 'Недействительна. Состав участников не редактируется.'");
	Иначе
		ТекстСостояния = "";
	КонецЕсли;
