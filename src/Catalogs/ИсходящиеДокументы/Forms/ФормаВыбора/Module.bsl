...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.Получатель) Тогда 
		...
		Если Параметры.Свойство("НеОтправленные") И ЗначениеЗаполнено(Параметры.НеОтправленные) Тогда
			Список.Параметры.УстановитьЗначениеПараметра("НеОтправленные", Параметры.НеОтправленные);
		Иначе 
			Список.Параметры.УстановитьЗначениеПараметра("НеОтправленные", Ложь);
		КонецЕсли;
	КонецЕсли;
