...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВозможныеСостоянияДокументовМЭДО = Перечисления.СостоянияДокументовМЭДО.СостоянияИсходящегоДокумента();
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.Переместить(Элементы.Получатели, Элементы.МК_НаименованиеПодготовил);
	...
	Элементы.Получатели.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
	Элементы.Получатели.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
	Элементы.Получатели.Высота = 1;
