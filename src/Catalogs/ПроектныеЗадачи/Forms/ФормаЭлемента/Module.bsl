...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыРазмещения.КоманднаяПанель = Элементы.ФормаГруппаКомандыФормы;
...
Функция ВывестиСостояниеПредшественников(Знач Предшественники)
	...
	Иначе	
		...
		Если Результат.Найти(Истина, "НеЗавершена") = Неопределено Тогда 	
			...
			СостояниеПредшественников = НСтр("ru = 'Все предшественники завершены.'");
			
		ИначеЕсли Результат.Найти(Истина, "Начата") = Неопределено Тогда 
			
			СостояниеПредшественников = НСтр("ru = 'Все предшественники не начаты.'");
			
		ИначеЕсли Результат.Найти(Истина, "НеНачата") <> Неопределено Тогда 	
			
			СостояниеПредшественников = НСтр("ru = 'Некоторые предшественники не начаты.'");
			
		Иначе 	
			
			СостояниеПредшественников = НСтр("ru = 'Некоторые предшественники не завершены.'");
