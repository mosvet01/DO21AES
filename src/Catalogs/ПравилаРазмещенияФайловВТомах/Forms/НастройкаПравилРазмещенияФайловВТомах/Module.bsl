...
Функция ВыполнитьЗапись()
	...
	Состояние(НСтр("ru = 'Идет заполнение очереди файлов на размещение. Пожалуйста, подождите...'"));
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Закончено формирование очереди файлов (в очередь добавлено файлов: %1)'"),
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(
			ОписаниеОповещения,
			НСтр("ru = 'Правила были изменены. Сохранить изменения?'"),
