...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Ссылка) Тогда
		Заголовок = Строка(Ссылка) + НСтр("ru=' (Правило)'");
	Иначе	
		Заголовок = НСтр("ru='Правило (Создание)'");
	КонецЕсли;	
...
Функция ВыполнитьЗаписьИЗакрыть()
	...
	Если ЕстьПравилоПоУмолчанию И ПоУмолчанию Тогда
		ТекстОшибки = НСтр("ru = 'Правило ""по умолчанию"" может быть только одно.'");
	...
	Если Не ПоУмолчанию И БезУсловий Тогда
		ТекстОшибки = НСтр("ru = 'Не указаны условия.'");
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		ПоказатьВопрос(
			ОписаниеОповещения,
			НСтр("ru = 'Правило было изменено. Сохранить изменения?'"), 
...
Процедура ПроверитьУсловие(Команда)
	...
	Если НетУсловий Тогда
		ПоказатьПредупреждение(,НСтр("ru='Нет условий отбора.'"));
		Возврат;
	КонецЕсли;	
