...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДоступныеПодразделения") Тогда
		ОформитьСписокПоДоступнымПодразделениям(Параметры.ДоступныеПодразделения);
	КонецЕсли;
...
&НаСервере
Процедура ОформитьСписокПоДоступнымПодразделениям(ДоступныеПодразделения)
	...
	Отбор.ПравоеЗначение = ДоступныеПодразделения;
	
	ЦветФона = НовоеУсловноеОформление.Оформление.Элементы.Найти("ЦветТекста");
	ЦветФона.Значение = ЦветаСтиля.НедоступныеДанныеЦвет;
