...
Процедура НастроитьФормуДляШаблонаПоУмолчанию()
	...
	Если Объект.Ссылка <> Справочники.ШаблоныСогласования.ПоУмолчанию Тогда
		Возврат;
	КонецЕсли;
	...
	Элементы.ИсполнителиОписаниеУсловия.Видимость = Ложь;
...
Процедура ЗаполнитьОбъектПоУмолчанию() Экспорт
	...
	ШаблонОбъект = ДанныеФормыВЗначение(Объект, Тип("СправочникОбъект.ШаблоныСогласования"));
