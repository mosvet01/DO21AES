...
Процедура МК_НастроитьЭлементыФормы()
	...
	МК_НастроитьГруппуДляВидаПросмотра(Элементы.СтраницаПапки);
	...
	Элементы.ПодписанУтвержден.Видимость = Ложь;
	...
	Элементы.Переместить(Элементы.СостояниеКонтроля, Элементы.ГруппаФайлыЗадачи);
	
	Элементы.Переместить(Элементы.Наименование, Элементы.МК_НаименованиеПодготовил, Элементы.МК_РегНомерИДата);
	Элементы.Переместить(Элементы.Подготовил, Элементы.МК_НаименованиеПодготовил);
	...
	Элементы.Подготовил.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
	Элементы.Подготовил.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
...
Процедура МК_НастроитьВидПросмотра()
	...
	// По папкам.
	Элементы.МК_ГруппаПапки.Видимость = Истина;
	Элементы.Переместить(Элементы.Папки, Элементы.МК_ГруппаПапки);
	Элементы.Папки.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделенияИВыбор;
...
Процедура МК_НастроитьФормуВАльбомномРежиме()
	...
	МобильныйКлиентКлиентСервер.АдаптироватьHtmlПодЭкранПриНеобходимости(ОбзорHTML);
