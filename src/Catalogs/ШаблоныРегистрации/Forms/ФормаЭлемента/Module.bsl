...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() Тогда
		ЗаголовокФормы = НСтр("ru = 'Регистрация (Создание)'");
...
Процедура НастроитьФормуДляШаблонаПоУмолчанию()
	...
	Если Объект.Ссылка <> Справочники.ШаблоныРегистрации.ПоУмолчанию Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьОбъектПоУмолчанию() Экспорт
	...
	ШаблонОбъект = ДанныеФормыВЗначение(Объект, Тип("СправочникОбъект.ШаблоныРегистрации"));
