...
//     НастройкиШаблона
//
Функция ПолучитьСтруктуруШаблонаРегистрации() Экспорт
...
//
Функция СоздатьШаблонРегистрации(СтруктураШаблона) Экспорт
...
// Параметры:
//   HTMLТекст - Строка
//   Шаблон - СправочникСсылка.ШаблоныРегистрации - ссылка на шаблон
//
...
//
// Параметры:
//  Шаблон - СправочникОбъект.ШаблоныРегистрации, СправочникСсылка.ШаблоныРегистрации - шаблон
//
// Возвращаемое значение:
//  ТаблицаЗначений
//   * Участник
...
Функция УчастникиДляПроверкиПрав(Шаблон) Экспорт
	...
	РаботаСБизнесПроцессами.ДобавитьУчастниковРегистрацииВТаблицу(ТаблицаУчастников, Шаблон);
...
//
// Параметры:
//  Процесс - СправочникСсылка.ШаблоныРегистрации - ссылка на шаблон
//
// Возвращаемое значение:
//  Структура
//
...
Функция ВыборкаДанныхДействий(ПараметрыДействий) Экспорт
	...
	Запрос.Текст = 
		...
		|	ШаблоныРегистрации.Наименование,
		|	ШаблоныРегистрации.Исполнитель,
		|	ШаблоныРегистрации.ВариантУстановкиСрокаИсполнения,
		|	ШаблоныРегистрации.СрокИсполнения,
		|	ШаблоныРегистрации.СрокИсполненияДни,
		|	ШаблоныРегистрации.СрокИсполненияЧасы,
		|	ШаблоныРегистрации.СрокИсполненияМинуты,
		|	ШаблоныРегистрации.Автор,
		|	ШаблоныРегистрации.ВариантУстановкиСрокаОбработкиРезультатов,
		|	ШаблоныРегистрации.СрокОбработкиРезультатов,
		|	ШаблоныРегистрации.СрокОбработкиРезультатовДни,
		|	ШаблоныРегистрации.СрокОбработкиРезультатовЧасы,
		|	ШаблоныРегистрации.СрокОбработкиРезультатовМинуты,
		|	ШаблоныРегистрации.КоличествоИтераций,
		|	ШаблоныРегистрации.СрокИсполненияПроцесса
		|ИЗ
		|	ПараметрыДействий КАК ПараметрыДействий
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ШаблоныРегистрации КАК ШаблоныРегистрации
		|		ПО ПараметрыДействий.ШаблонПроцесса = ШаблоныРегистрации.Ссылка";
...
//
// Параметры:
//  Объект - СправочникСсылка.ШаблоныРегистрации, ВыборкаДанных
//
// Возвращаемое значение:
...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		...
		ВыбраннаяФорма = "Справочник.ШаблоныРегистрации.Форма.ФормаЭлемента";
	...
	Если ВидФормы = "ФормаВыбора" Тогда
		...
		Параметры.Вставить("ТипШаблона", "Регистрация");
