...
Процедура КалендарьПриЗаписиПредмета(Источник, Отказ) Экспорт
	...
	Если (ИзмениласьПометкаУдаления И Источник.ПометкаУдаления = Истина)
		Или (ИзменилосьОтменено И Отменено = Истина)
		Или (ИзменилисьРеквизиты
			И ЗначениеЗаполнено(ПредыдущиеЗначенияРеквизитов.ДатаНачала)
			И Не ЗначениеЗаполнено(Источник.ДатаНачала)) Тогда
