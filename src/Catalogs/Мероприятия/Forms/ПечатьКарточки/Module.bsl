...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры.ПараметрКоманды) <> Тип("Массив") Или Параметры.ПараметрКоманды.Количество() > 1 Тогда
		Заголовок = НСтр("ru = 'Печать карточек мероприятий'");
	Иначе
		Заголовок = НСтр("ru = 'Печать карточки мероприятия'");
	КонецЕсли;
...
Процедура ПриСозданииНаСервереРедакцииКонфигурации()	
	...
	Элементы.ВыводитьОрганизацию.Заголовок = РедакцииКонфигурацииКлиентСервер.Организация();
