...
Процедура МК_НастроитьЭлементыФормы()
	...
	Для каждого Элемент из Элементы.ГруппаПраваяКолонка.ПодчиненныеЭлементы Цикл
		Если ТипЗнч(Элемент) = Тип("ПолеФормы") Тогда
			ВыровнятьЭлементФормыДляМобильного(Элемент);
		КонецЕсли;
	КонецЦикла;
	...
	// Страница "Участники".
	Элементы.МК_ДекорацияОтступПередПодваломУчастники.Видимость = Истина;
	
	Элементы.Участники.Шапка = Ложь;
	Элементы.МК_УчастникиГруппаКолонок.Видимость = Истина;
	Элементы.Переместить(Элементы.УчастникиИсполнитель, Элементы.ГруппаУчастники);
	Элементы.Переместить(Элементы.УчастникиСостояниеПриглашения, Элементы.МК_ГруппаПриглашение);
	...
	Элементы.УчастникиПригласитьУчастников.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.УчастникиПодобрать.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.УчастникиПодобратьВремя.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.УчастникиПроверитьДоступностьУчастников.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.УчастникиДобавить.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВКоманднойПанели;
		
	ВыровнятьЭлементФормыДляМобильного(Элементы.Председатель);
	ВыровнятьЭлементФормыДляМобильного(Элементы.Секретарь);
	
	// Страница "Программа".
	Элементы.МК_ДекорацияОтступПередПодваломПрограмма.Видимость = Истина;
	
	Элементы.Программа.Шапка = Ложь;
	Элементы.Программа.Подвал = Ложь;
	Элементы.МК_ПрограммаГруппаКолонок.Видимость = Истина;
	Элементы.Переместить(Элементы.ПрограммаСодержание, Элементы.ГруппаСодержаниеИсполнитель);
	Элементы.Переместить(Элементы.ПрограммаГруппаИсполнитель, Элементы.ГруппаСодержаниеИсполнитель);	
	Элементы.Переместить(Элементы.ПрограммаНачало, Элементы.ГруппаВремя);
	Элементы.Переместить(Элементы.ПрограммаОкончание, Элементы.ГруппаВремя);

	Элементы.Программа.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделенияИВыбор;
	...
	Элементы.УтвердитьПрограмму.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПрограммаИзменить.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПрограммаУдалить.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.УчастникиПодобрать.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ВестиПрограммуВОтдельномДокументе.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ВестиПрограммуВТаблице.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ВестиПрограммуВФайлах.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	...
	Элементы.Переместить(Элементы.ПротоколРешили, Элементы.ГруппаРешилиИсполнители);
	Элементы.Переместить(Элементы.ПротоколГруппаИсполнитель, Элементы.ГруппаРешилиИсполнители);
	Элементы.Переместить(Элементы.РешенияСрокИсполнения, Элементы.ГруппаСрок);	
		
	Элементы.Протокол.ИспользованиеТекущейСтроки = ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделенияИВыбор;
	...
	Элементы.РешенияСрокИсполнения.Формат = НСтр("ru='ДФ=''dd.MM.yy'''");
	Элементы.СтраницаРешения.ЦветФона = ЦветаСтиля.МК_ЦветФонаГруппы;
	Элементы.РешенияИсполнитель.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
	Элементы.РешенияИсполнитель.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
	
	Элементы.ПротоколЗаполнитьПротокол.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколИзменить.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколУдалить.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколВестиПротоколВОтдельномДокументе.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколВестиПротоколВТаблице.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколВестиПротоколВФайлах.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколЗаполнитьПротоколНаОснованииПредыдущего.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
		
	Элементы.ПротоколПодготовитьПротокол.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколСогласоватьПротокол.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколУтвердитьПротокол.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ПротоколИсполнитьПротокол.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	...
	Элементы.ФайлыВставитьКартинкуИзБуфера.Видимость = Ложь;
	...
	Элементы.ФайлыЗапроситьМатериалы.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.ФайлыОзнакомитьСМатериалами.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	...
	Элементы.ПодобратьУчастниковРабочейГруппы.ПоложениеВКоманднойПанели = 
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	...
	Элементы.МК_ГруппаДополнительно.Видимость = Истина;
	Элементы.Переместить(Элементы.ГруппаНачалоФакт, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.ГруппаОкончаниеФакт, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.Организация, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.Проект, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.Куратор, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.Подготовил, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.Подразделение, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.ПредыдущееМероприятие, Элементы.МК_ГруппаДополнительно);
	Элементы.Переместить(Элементы.СледующееМероприятие, Элементы.МК_ГруппаДополнительно);
