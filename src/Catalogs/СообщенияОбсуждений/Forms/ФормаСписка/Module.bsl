...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	// Отображение области чтения
	Если ВариантОбластиЧтения <> Перечисления.ВариантыОтображенияОбластиЧтения.Внизу Тогда
		ОбновитьОтображениеОбластиЧтенияСервер();
	КонецЕсли;
...
Процедура ОбластьЧтенияОтключена(Команда)
	...
	ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.НеОтображать");
	ОбновитьОтображениеОбластиЧтенияСервер();
...
Процедура ОбластьЧтенияСнизу(Команда)
	...
	ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.Внизу");
	ОбновитьОтображениеОбластиЧтенияСервер();
...
Процедура ОбластьЧтенияСправа(Команда)
	...
	ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.Справа");
	ОбновитьОтображениеОбластиЧтенияСервер();
...
Процедура ОбновитьОтображениеОбластиЧтенияСервер()
	...
	Если ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.Внизу") Тогда
	...
	ИначеЕсли ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.Справа") Тогда
	...
	ИначеЕсли ВариантОбластиЧтения = ПредопределенноеЗначение("Перечисление.ВариантыОтображенияОбластиЧтения.НеОтображать") Тогда
