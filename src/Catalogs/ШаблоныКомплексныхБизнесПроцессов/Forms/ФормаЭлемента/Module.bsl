...
Процедура ЭтапыПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если Не РаботаСКомплекснымиБизнесПроцессамиКлиент.
		ЗаписатьНовыйШаблонПередНастройкойПодчиненногоЭлемента(ЭтаФорма) Тогда
...
Процедура ЗаполнитьОбъектПоУмолчанию() Экспорт
	...
	РаботаСКомплекснымиБизнесПроцессамиСервер.ЗаполнитьСхемуШаблонаПоУмолчаниюВФорме(ЭтаФорма);
