...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Номенклатура дел'");
	КомандаПечати.СписокФорм = "ФормаСписка";
	КомандаПечати.Порядок = 10;
	КомандаПечати.Обработчик = "УправлениеПечатьюКлиентДокументооборот.ПечатьНоменклатурыДел";
	
	// Печать итоговой записи
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.МенеджерПечати = "Справочник.НоменклатураДел";
	КомандаПечати.Идентификатор = "ИтоговаяЗапись";
	КомандаПечати.Представление = НСтр("ru = 'Итоговая запись о категориях и количестве дел'");
	КомандаПечати.СписокФорм = "ФормаСписка";
	КомандаПечати.Порядок = 20;
	КомандаПечати.Обработчик = "УправлениеПечатьюКлиентДокументооборот.ПечатьИтоговойЗаписиНоменклатурыДел";
