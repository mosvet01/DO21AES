...
Процедура СоздатьРазделы(Команда)
	...
	Если Не ЕстьОтмеченные Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru = 'Не отмечено ни одного подразделения.'"),, "ДеревоРазделов");
		Возврат;
	КонецЕсли;
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru = 'Копирование:'"), ,
		НСтр("ru = 'Созданы отмеченные разделы номенклатуры дел'"),
...
Процедура ПриСозданииНаСервереРедакцииКонфигурации()	
	...
	Заголовок = РедакцииКонфигурацииКлиентСервер.ЗаполнениеРазделов();
	Элементы.Организация.Заголовок = РедакцииКонфигурацииКлиентСервер.ДляОрганизации();
