...
Процедура МК_НастроитьЭлементыФормы()
	...
	МК_ВыровнятьЭлементФормы(Элементы.УчетнаяЗапись);
	МК_ВыровнятьЭлементФормы(Элементы.Важность);
	МК_ВыровнятьЭлементФормы(Элементы.Предмет);
	МК_ВыровнятьЭлементФормы(Элементы.Проект);
	
	Элементы.ДекорацияОтступ.Видимость = Ложь;
	Элементы.ТекстПисьма.РастягиватьПоВертикали = Истина;
