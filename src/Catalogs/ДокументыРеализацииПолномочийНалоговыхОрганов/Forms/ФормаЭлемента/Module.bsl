...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "СозданДокументДокументооборотаНаОснованииДокументаКО"
		И Параметр.ДокументОтчетности = Объект.Ссылка Тогда
		ДокументДокументооборота = Параметр.ДокументДокументооборота;
		УстановитьВидимостьКомандДО(ЭтотОбъект);
	КонецЕсли;
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ДокументДокументооборота =
		ОтчетностьВКонтролирующиеОрганы.ВходящийДокументПоЭлектронномуДокументуКО(ТекущийОбъект.Ссылка);
	УстановитьВидимостьКомандДО(ЭтотОбъект);
...
&НаКлиенте
Процедура ПерезаполнитьВходящийДокумент(Команда)
	...
	Иначе
		...
		ПараметрыОповещения.Вставить("ДокументОтчетности", Объект.Ссылка);
...
Процедура УправлениеКнопкамиОтвета(КонтекстЭДОСервер)
	...
	Элементы.ПодготовитьРеестрДокументов.Видимость                       = ЭтоТребованиеОПредставленииДокументов;
...
Функция ПрорисоватьПриложения()
	...
	Если ЭтоТребованиеОПредставленииПояснений ИЛИ ЭтоРешениеПоЖалобе Тогда
		// Не показываем xml-файлы, если это требование о представлении пояснений к декларации по НДС или Решение по жалобе
...
#Область АдаптацияДокументооборот

&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьКомандДО(Форма)
	
	Форма.Элементы.СоздатьВодящийДокументДокументооборота.Видимость = Не ЗначениеЗаполнено(Форма.ДокументДокументооборота);
	Форма.Элементы.ПерезаполнитьВходящийДокумент.Видимость = ЗначениеЗаполнено(Форма.ДокументДокументооборота);
