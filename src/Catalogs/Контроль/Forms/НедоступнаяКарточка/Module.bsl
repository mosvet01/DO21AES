...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе 	
		СрокИсполнения = НСтр("ru = 'не указан'");
	КонецЕсли;
	...
	Если КарточкаКонтроля.СнятСКонтроля Тогда 
		HTMLТекст = HTMLТекст + "<B>" + НСтр("ru = 'Снят с контроля'") + "</B>";	
		HTMLТекст = HTMLТекст + "<p>";
		ДобавитьРеквизит(HTMLТекст, НСтр("ru = 'Контролер:'"), Строка(КарточкаКонтроля.Контролер));
		HTMLТекст = HTMLТекст + "<p>";
		ДобавитьРеквизит(HTMLТекст, НСтр("ru = 'Дата:'"), Формат(КарточкаКонтроля.ДатаСнятияСКонтроля, "ДЛФ=D"));
	Иначе
		HTMLТекст = HTMLТекст + "<B>" + НСтр("ru = 'На контроле'") + "</B>";	
		HTMLТекст = HTMLТекст + "<p>";
		ДобавитьРеквизит(HTMLТекст, НСтр("ru = 'Контролер:'"), Строка(КарточкаКонтроля.Контролер));
		HTMLТекст = HTMLТекст + "<p>";
		ДобавитьРеквизит(HTMLТекст, НСтр("ru = 'Срок:'"), СрокИсполнения);
	КонецЕсли;
