...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ПоставитьНаКонтроль.Картинка = БиблиотекаКартинок.ЗаписатьИЗакрыть;
	Элементы.ПоставитьНаКонтроль.Отображение = ОтображениеКнопки.Картинка;
	Элементы.Отмена.Видимость = Не Объект.СнятСКонтроля;
	Элементы.Отмена.Картинка = БиблиотекаКартинок.Удалить;
	...
	Для Каждого ПодчиненныйЭлемент Из Элементы.ГруппаКомПанельИсполнители.ПодчиненныеЭлементы Цикл
