...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("РежимВыбораПапкиИФайла") Тогда 
		РежимВыбораПапкиИФайла = Параметры.РежимВыбораПапкиИФайла;
	КонецЕсли;	
	...
	Иначе
		...
		Если ВыборШаблона Тогда
			Заголовок = НСтр("ru = 'Выбор шаблона файла'");
		КонецЕсли;
		
	КонецЕсли;
	
	ВыбранныеФайлыНадпись = НСтр("ru = 'Выбранные файлы:'");
...
Процедура Выбрать(Команда)
	...
	Иначе
		Если ВыбранныеЗначения.Количество() = 0 Тогда
			Если Элементы.Список.ТекущаяСтрока = Неопределено Тогда
				ПоказатьПредупреждение(, НСтр("ru = 'Не выбран ни один файл.'"));
				Возврат;
			КонецЕсли;
			ОповеститьОВыборе(Элементы.Список.ТекущаяСтрока);
...
Процедура ПапкиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если РежимВыбораПапкиИФайла Тогда
		Если Элементы.Папки.ТекущиеДанные <> Неопределено Тогда
			СтандартнаяОбработка = Ложь;
			ОповеститьОВыборе(Элементы.Папки.ТекущаяСтрока);
		КонецЕсли;	
	КонецЕсли;	
