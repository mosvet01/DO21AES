...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ИспользоватьImageMagickДляПреобразованияВPDF.Видимость 
		= ИспользоватьGhostscript И ИспользоватьImageMagickДляРаспознаванияPDF;
		
	Элементы.ГруппаФорматаХранения.Видимость = ИспользоватьImageMagickДляПреобразованияВPDF;
	Элементы.ГруппаФорматХраненияМногостраничный.Видимость = ИспользоватьImageMagickДляПреобразованияВPDF;
