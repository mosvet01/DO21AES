...
//     НастройкиШаблона
//
Функция ПолучитьСтруктуруШаблонаОзнакомление() Экспорт
...
//
Функция СоздатьШаблонОзнакомления(СтруктураШаблона) Экспорт
...
// Параметры:
//   HTMLТекст - Строка
//   Шаблон - СправочникСсылка.ШаблоныОзнакомления - ссылка на шаблон
//
...
//
// Параметры:
//  Шаблон - СправочникОбъект.ШаблоныОзнакомления, СправочникСсылка.ШаблоныОзнакомления - шаблон
//
// Возвращаемое значение:
//  ТаблицаЗначений
//   * Участник
...
Функция УчастникиДляПроверкиПрав(Шаблон) Экспорт
	...
	РаботаСБизнесПроцессами.ДобавитьУчастниковОзнакомленияВТаблицу(ТаблицаУчастников, Шаблон);
...
//
// Параметры:
//  Процесс - СправочникСсылка.ШаблоныОзнакомления - ссылка на шаблон
//
// Возвращаемое значение:
//  Структура
//
...
Функция ВыборкаДанныхДействий(ПараметрыДействий) Экспорт
	...
	Запрос.Текст = 
		...
		|	ШаблоныОзнакомления.Наименование,
		|	ШаблоныОзнакомления.Исполнители,
		|	ШаблоныОзнакомления.СрокИсполненияПроцесса
		|ИЗ
		|	ПараметрыДействий КАК ПараметрыДействий
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ШаблоныОзнакомления КАК ШаблоныОзнакомления
		|		ПО ПараметрыДействий.ШаблонПроцесса = ШаблоныОзнакомления.Ссылка";
...
//
// Параметры:
//  Объект - СправочникСсылка.ШаблоныОзнакомления, ВыборкаДанных
//
// Возвращаемое значение:
...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		...
		ВыбраннаяФорма = "Справочник.ШаблоныОзнакомления.Форма.ФормаЭлемента";
	...
	Если ВидФормы = "ФормаВыбора" Тогда
		...
		Параметры.Вставить("ТипШаблона", "Ознакомление");
