...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.ЭлементыФормы.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;

	Элементы.ПоследниеВыбранныеКатегории.АвтоМаксимальнаяВысота = Ложь;
	Элементы.ФормаКомандаГотово.Отображение = ОтображениеКнопки.Картинка;
	Элементы.ФормаКомандаГотово.Картинка = БиблиотекаКартинок.ЗаписатьИЗакрыть;
	
	Элементы.УдалитьКатегорииИзСпискаВыбранных.Видимость = Ложь;
	
	Элементы.ДобавитьКСпискуВыбранных.Заголовок = НСтр("ru = 'Добавить к списку выбранных'");
	
	Элементы.Переместить(
		Элементы.ДобавитьКСпискуВыбранных, 
		Элементы.ДеревоКатегорий.КонтекстноеМеню, 
		Элементы.ДеревоКатегорий.КонтекстноеМеню);
	
	Элементы.ДеревоКатегорий.РастягиватьПоВертикали = Истина;
	
	Элементы.ПоследниеВыбранныеКатегории.АвтоМаксимальнаяВысотаВСтрокахТаблицы = Ложь;
