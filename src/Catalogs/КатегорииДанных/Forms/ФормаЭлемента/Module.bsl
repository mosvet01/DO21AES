...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		Если НЕ РольДоступна("ДобавлениеИзменениеОбщихКатегорий") 
			...
			Объект.Доступ.Добавить().Пользователь = Пользователи.ТекущийПользователь();
...
Процедура ПодобратьПользователейЛичныйДоступ(Команда)
	...
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru = 'Подбор пользователей, подразделений, групп, ролей'"));
...
Процедура ДоступПользовательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru = 'Выбор пользователя, подразделения, группы'"));
	ПараметрыФормы.Вставить("ЗаголовокСпискаАдреснойКниги", НСтр("ru = 'Все пользователи'"));
