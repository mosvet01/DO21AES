...
Процедура ОбновитьВидимостьРеквизитов()
	...
	Если ПараметрыФункциональныхОпций.ВидИсходящегоДокумента.ВестиУчетПоНоменклатуреДел 
		Или ПолучитьФункциональнуюОпцию("РаздельныйУчетДокументов") Тогда
		Элементы.ГруппаХранение.ОтображатьЗаголовок = Истина;
		Элементы.НоменклатураДел.Видимость = ПараметрыФункциональныхОпций.ВидИсходящегоДокумента.ВестиУчетПоНоменклатуреДел;
	Иначе
	...
	Если ПараметрыФункциональныхОпций.ВидИсходящегоДокумента.УчитыватьМестоХранения <> ВариантНеУчитывать Тогда
		Элементы.МестоХранения.Видимость = ПоказыватьПоляХранения;
	Иначе
		Элементы.МестоХранения.Видимость = Ложь;
	КонецЕсли;
	
	Если ПараметрыФункциональныхОпций.ВидИсходящегоДокумента.УчитыватьОтветственногоЗаХранение <> ВариантНеУчитывать Тогда
