...
Процедура ОтобразитьКалендарьЗанятости()
	...
	НастройкиОтображения.Пользователи = ПолучитьМассивУчастников(Ложь);
	...
	НастройкиОтображения.ОтображатьОбщуюЗанятость = Истина;
	НастройкиОтображения.ПериодОтображения = Перечисления.ПериодОтображенияРабочегоКалендаря.День;
	НастройкиОтображения.ИсключенияЗанятости.Добавить(Мероприятие);
