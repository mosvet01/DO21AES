...
Процедура ОбновитьПредставлениеМестногоЧасовогоПояса()
	...
	Если НастройкаРежимОтображенияМестногоВремени <> Перечисления.РежимыОтображенияМестногоВремени.ВремяСеанса Тогда
		...
		ЧасовойПоясПользователя = РаботаСЧасовымиПоясами.ЧасовойПоясПользователя(Объект.Пользователь);
		...
		Если ЧасовойПоясПользователя <> ЧасовойПоясПоУмолчанию Тогда
			ПредставлениеМестногоЧасовогоПояса = РаботаСЧасовымиПоясами.ПредставлениеЧасовогоПоясаДО(ЧасовойПоясПользователя);
		Иначе
			ПредставлениеМестногоЧасовогоПояса = "";
		КонецЕсли;
		
		ЧасовойПоясТекущегоПользователя = РаботаСЧасовымиПоясами.ЧасовойПоясПользователя(Пользователи.ТекущийПользователь());
		Если ЧасовойПоясТекущегоПользователя <> ЧасовойПоясПользователя Тогда
