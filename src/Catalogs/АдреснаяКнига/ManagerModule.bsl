...
Процедура ОбновитьСписокПодчиненныхОбъектов(
	...
	ОтображатьВАдреснойКниге = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
		ОбъектАдреснойКниге, "ОтображатьВАдреснойКниге");
	...
	Для Каждого СтрАдреснойКниги ИЗ СписокПодчиненныхВАдреснойКниге Цикл
		...
		ИначеЕсли СтрАдреснойКниги.ОбъектДоступа <> ОбъектДоступа
			Или СтрАдреснойКниги.ОтображатьВАдреснойКниге <> ОтображатьВАдреснойКниге Тогда
...
Процедура УстановитьПризнакОтображенияОбъектаВАдреснойКниге(ЭлементАдреснойКниги, Объект) Экспорт
	
	ТипОбъекта = ТипЗнч(Объект);
	
	Если Не ЗначениеЗаполнено(ЭлементАдреснойКниги.РодительОбъекта)
		И (ЭлементАдреснойКниги.Предопределенный Или ТипОбъекта = Тип("Строка")) Тогда
	...
	ТипРодителя = ТипЗнч(ЭлементАдреснойКниги.РодительОбъекта);
	
	ТипыВлияющиеНаПодчиненных = Новый Соответствие();
	ТипыВлияющиеНаПодчиненных.Вставить(
		Тип("СправочникСсылка.СтруктураПредприятия"), Истина);
	ТипыВлияющиеНаПодчиненных.Вставить(
		Тип("СправочникСсылка.РабочиеГруппы"), Истина);
	ТипыВлияющиеНаПодчиненных.Вставить(
		Тип("СправочникСсылка.ГруппыКонтактовПользователей"), Истина);
	ТипыВлияющиеНаПодчиненных.Вставить(
		Тип("СправочникСсылка.Мероприятия"), Истина);
	ТипыВлияющиеНаПодчиненных.Вставить(
		Тип("СправочникСсылка.Проекты"), Истина);
	
	Если ЗначениеЗаполнено(ЭлементАдреснойКниги.Родитель)  
		И ЗначениеЗаполнено(ЭлементАдреснойКниги.РодительОбъекта) 
		И ТипыВлияющиеНаПодчиненных[ТипРодителя] = Истина
		И Не ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
			ЭлементАдреснойКниги.Родитель, "ОтображатьВАдреснойКниге") Тогда
	
		ОтображатьОбъектВАдреснойКниге = Ложь;
