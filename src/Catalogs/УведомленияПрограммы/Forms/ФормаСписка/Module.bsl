...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Перенесем команды из подменю.
	Элементы.Переместить(
		Элементы.ГруппаКоманднаяПанельНастройкиСписка, Элементы.ГруппаКоманднаяПанель, Элементы.ФормаОбновить);
	Элементы.Переместить(
		Элементы.ФормаПоказыватьУдаленные, Элементы.ГруппаКоманднаяПанель, Элементы.ФормаВывестиСписок);
	...
	// Перенесем общие команды в контекстное меню.
	Элементы.Переместить(Элементы.ОтправитьОбъекты,Элементы.Список.КонтекстноеМеню);
	
	// Настроим положение поиска.
	Элементы.Список.ПоложениеСтрокиПоиска = ПоложениеСтрокиПоиска.КоманднаяПанель;
