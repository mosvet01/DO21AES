...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Настроим группу АвтоНаименование и Наименование.
	Элементы.ГруппаАвтоНаименование.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	Элементы.АвтоНаименование.Заголовок = НСтр("ru = 'Авто наименование'");
	Элементы.АвтоНаименование.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.АвтоНаименование.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Право;
	...
	Элементы.Переместить(Элементы.Код, Элементы.ГруппаНаименование, Элементы.ГруппаАвтоНаименование);
	Элементы.Код.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.Код.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.Код.РастягиватьПоГоризонтали = Истина;
	
	// Настроим истроию показателя.
	Элементы.ОтчетМониторингПроцессовПоказательПроцесса.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Лево;
	Элементы.ОтчетМониторингПроцессовПоказательПроцесса.Отображение = ОтображениеКнопки.Текст;
	
	Элементы.ПериодРасчета.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.ПериодРасчета.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.ПериодРасчета.РастягиватьПоГоризонтали = Истина;
	
	// Уберем серые отступы.
	Элементы.СтраницаПоказательПроцесса.ВертикальныйИнтервал = ИнтервалМеждуЭлементамиФормы.Нет;	
