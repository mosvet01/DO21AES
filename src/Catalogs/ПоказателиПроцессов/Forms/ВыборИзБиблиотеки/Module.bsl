...
&НаКлиенте
Процедура ТипыОснованияОбработкаЗапросаОбновления()
	Элементы.ТипыОснования.Обновить();
КонецПроцедуры
...
&НаКлиенте
Процедура ОснованияОбработкаЗапросаОбновления()
	Элементы.Основания.Обновить();
КонецПроцедуры
...
&НаКлиенте
Процедура ВариантыРасчетаОбработкаЗапросаОбновления()
	Элементы.ВариантыРасчета.Обновить();
КонецПроцедуры
...
&НаКлиенте
Процедура ВариантыОтбораОбработкаЗапросаОбновления()
	Элементы.ВариантыОтбора.Обновить();
КонецПроцедуры
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	НастроитьСпискиМК(Элементы.ТипыОснования);
	НастроитьСпискиМК(Элементы.Основания);
	НастроитьСпискиМК(Элементы.ВариантыРасчета);
	НастроитьСпискиМК(Элементы.ВариантыОтбора);
	
	Элементы.Далее.Заголовок = НСтр("ru = 'Далее'");
	
	Элементы.СтраницаОснование.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяЕслиВозможно;
	Элементы.СтраницаВариантПоказателя.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяЕслиВозможно;

КонецПроцедуры

Процедура НастроитьСпискиМК(Список)
	
	Список.Высота = 5;
	Список.ВариантУправленияВысотой = ВариантУправленияВысотойТаблицы.ВСтрокахТаблицы;
	Список.ПоложениеСтрокиПоиска = ПоложениеСтрокиПоиска.Верх;
