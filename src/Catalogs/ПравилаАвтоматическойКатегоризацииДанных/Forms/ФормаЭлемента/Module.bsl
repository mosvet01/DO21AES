...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Используется Тогда
		Элементы.Используется.Подсказка = НСтр("ru = 'Данное правило будет использоваться при автокатегоризации.'");
	Иначе
		Элементы.Используется.Подсказка = НСтр("ru = 'Данное правило не будет использоваться при автокатегоризации.'");
	КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если НЕ ЗначениеЗаполнено(СписокДопустимыхТипов) Тогда
		Текст = НСтр("ru = 'Не отмечено ни одного типа объектов для правила'");	
	...
	Если Объект.Условия.Количество() = 0 Тогда
		Текст = НСтр("ru = 'Не задано ни одного условия'");	
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Текст = НСтр("ru = 'Идет обновление признака автоматической категоризации данных. Пожалуйста, подождите...'");
	Состояние(Текст);
