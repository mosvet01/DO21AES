...
Функция СписокТиповШаблонов()
	...
	СписокТипов.Добавить("ОбработкаВнутреннегоДокумента", НСтр("ru = 'Обработка внутреннего документа'"));
	СписокТипов.Добавить("ОбработкаВходящегоДокумента", НСтр("ru = 'Обработка входящего документа'"));
	СписокТипов.Добавить("ОбработкаИсходящегоДокумента", НСтр("ru = 'Обработка исходящего документа'"));
