...
Функция ПолучитьКоллекцию(ЗначенияДоступа) Экспорт
	...
	Иначе
		...
		ВызватьИсключение НСтр("ru = 'Найдено несколько идентичных коллекций значений доступа.'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Удаление устаревших коллекций'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
