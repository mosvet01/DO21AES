...
Процедура ВидУслугиПриИзменении(Элемент)
	...
	ЗадатьЗначениеТипаСверкиПоУмолчанию();
	УстановитьВидимостьИнформационнойПанели();
	УправлениеФормой(ЭтаФорма);
...
&НаСервере
Процедура ЗадатьЗначениеТипаСверкиПоУмолчанию()
...
Процедура УстановитьФорматОтветаПоУмолчанию()
	...
	Если Параметры.Ключ.Пустая() Тогда
		Если Объект.ВидУслуги = Перечисления.ВидыУслугПриИОН.ПредставлениеСправкиОбИсполненииОбязанностейПоУплате
			ИЛИ Объект.ВидУслуги = Перечисления.ВидыУслугПриИОН.ПредставлениеАктовСверкиРасчетов
			ИЛИ Объект.ТипСверки = Перечисления.ТипыСверокИОН.ВЦеломПоОрганизации Тогда
...
Процедура УправлениеФорматомОтвета(Форма)
	...
	Элементы.ФорматОтветаПредставление.Видимость = 
		...
		И Объект.ТипСверки <> ПредопределенноеЗначение("Перечисление.ТипыСверокИОН.ВЦеломПоОрганизации");
