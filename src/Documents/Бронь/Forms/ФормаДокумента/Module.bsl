...
Процедура МК_НастроитьЭлементыФормы()
	...
	// Дата.
	Элементы.МК_ГруппаДата.Видимость = Истина;
	Элементы.Переместить(Элементы.ДатаНачала, Элементы.МК_Начало);
	Элементы.Переместить(Элементы.ДатаНачалаВремя, Элементы.МК_Начало);
	
	Элементы.Переместить(Элементы.ДекорацияРазделительВремени, Элементы.МК_ГруппаДата, Элементы.МК_Окончание);
	
	Элементы.Переместить(Элементы.ДатаОкончания, Элементы.МК_Окончание);
	Элементы.Переместить(Элементы.ДатаОкончанияВремя, Элементы.МК_Окончание);
	...
	Элементы.ГруппаДата.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	...
	Элементы.Комментарий.АвтоМаксимальнаяВысота = Истина;
	
	// Дополнительно.
	Элементы.ГруппаДополнительно.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
