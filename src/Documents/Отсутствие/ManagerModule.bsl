...
Функция ПолучитьПредставлениеHTML(Отсутствие) Экспорт
	...
	РеквизитыОтсутствия = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Отсутствие,
		...
		|ВесьДень, Комментарий, Заместители, БудуРазбиратьЗадачи");
	...
	// Кто
	ЧасовойПоясСотрудника = РаботаСЧасовымиПоясами.ЧасовойПоясПользователя(РеквизитыОтсутствия.Сотрудник);
	...
	// Буду на связи
	Если РеквизитыОтсутствия.БудуРазбиратьЗадачи Тогда
		ПредставлениеHTML = ПредставлениеHTML
			+ "<B>"
			+ Метаданные.Документы.Отсутствие.Реквизиты.БудуРазбиратьЗадачи.Синоним
			+ "</B><BR>";
	КонецЕсли;
