...
Функция КоличествоПрисоединенныхФайлов()
	...
	РаботаСФайлами.ЗаполнитьПрисоединенныеФайлыКОбъекту(ВладелецПрисоединенныхФайлов, ПрисоединенныеФайлыМассив);
	
	Возврат ПрисоединенныеФайлыМассив.Количество();
...
Процедура ПодготовитьПредставлениеФайла(ЭлементСхемыРегламента)
	...
	Если ДанныеФайла.ФайлРедактируется Тогда
		...
		Элементы.НадписьРедактируетФайл.ЦветТекста = ЦветаСтиля[?(ДанныеФайла.РедактируетТекущийПользователь,
...
Процедура УстановитьВидимостьДоступностьПоПереходуНаНовуюВерсию()
	...
	Элементы.ЗаписатьДокумент.Видимость = Ложь;
	Элементы.ОтклонитьПодписание.Видимость = Ложь;
	Элементы.ОтклонитьПодписаниеДокумент.Видимость = Ложь;
	Элементы.ОтправитьПовторноДокумент.Видимость = Ложь;
