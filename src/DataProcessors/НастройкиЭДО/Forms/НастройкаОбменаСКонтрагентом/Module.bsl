...
Процедура ЗаписатьОбновленныеНастройки(НастройкаОтправки, КлючНастроекОтправки, ВыборУчетныхЗаписей)
	...
	Если ВыборУчетныхЗаписей И Не НастройкиОтправкиЭДОСлужебный.ЭтоРасширеннаяНастройка(КлючНастроекОтправки) Тогда
		НастройкиОтправкиЭДОСлужебный.ИзменитьТранспортныеНастройки(КлючНастроекОтправки,
			НастройкаОтправки.ИдентификаторОтправителя, НастройкаОтправки.ИдентификаторПолучателя);
	Иначе 
		НастройкиОтправкиЭДОСлужебный.ИзменитьНастройку(НастройкаОтправки);
	КонецЕсли;
