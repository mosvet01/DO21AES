...
Процедура МК_НастроитьЭлементыформы()
	...
	Элементы.ДеревоОтчетовИВариантов.ИспользованиеТекущейСтроки =
		ИспользованиеТекущейСтрокиТаблицы.ОтображениеВыделения;

	Элементы.КартинкаОтчета.Видимость = МобильныйКлиентВызовСервера.ЭтоМобильныйСБольшимЭкраном();

	Элементы.ФормаДополнительныеОтчеты.ПоложениеВКоманднойПанели =
		ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	Элементы.Переместить(Элементы.ФормаДополнительныеОтчеты, КоманднаяПанель);
