...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		СтатусПодключенияСканераШтрихкодов = НСтр("ru = 'Подключен к порту '") + ПараметрыСканера.Порт; 
	КонецЕсли;
...
Процедура СохранитьПараметрыПодключенияСканера(ТипОС, ВыбранныеПараметры)
	...
	СтатусПодключенияСканераШтрихкодов = НСтр("ru = 'Подключен к порту '") + ВыбранныеПараметры.Порт;
