...
Функция Инициализация()
	...
	НеПредлагатьУстановкуРасширения = ДоступнаЭПВМоделиСервиса И ОбщегоНазначения.ЭтоВебКлиент();
...
Процедура НачатьОткрытьЗаявлениеНаПодключениеУпрощенное()
	...
	Иначе
		...
		Иначе
			...
			ИначеЕсли РезультатПолученияТикета.КодОшибки = "ПревышеноКоличествоПопыток" Тогда
