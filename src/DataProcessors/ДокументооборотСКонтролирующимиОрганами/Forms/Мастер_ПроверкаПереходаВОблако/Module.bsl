...
Процедура ПодготовитьОформлениеФормы()
	...
	Если ВариантОформления = 0 Тогда
		...
		ТекстЗаголовка = НСтр("ru = 'Поиск сертификата на рабочем компьютере'");
		ТекстИнформации = НСтр("ru = 'Подождите, идет поиск сертификата руководителя на рабочем компьютере.'");
	...
	ИначеЕсли ВариантОформления = 1 // компонента не установлена
		...
		Элементы.ФормаОтмена.Заголовок = НСтр("ru = 'Отправить заявления позже'");
		ТекстЗаголовка = НСтр("ru = 'Перевод хранения закрытых ключей в ""облако""'");
		ТекстИнформации = НСтр("ru = 'После перехода на хранение ключа в защищенном хранилище сервиса могут возникнуть проблемы с расшифровкой сообщений по 1С-Отчетности, которые высланы до момента смены ключа, но еще не получены вами и не расшифрованы.'")
