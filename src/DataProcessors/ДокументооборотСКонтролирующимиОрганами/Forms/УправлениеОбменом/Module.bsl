...
Процедура КомандаУведомленияСоздать(Команда)
	...
	Если СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки() Тогда
		СписокВариантовВыбора.Добавить("ДоходыОтДеятельностиМузеяТеатраБиблиотеки", НСтр("ru='Доходы от деятельности музея, театра, библиотеки'"));
	КонецЕсли;
	
	Если СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ() Тогда
		СписокВариантовВыбора.Добавить("ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ", НСтр("ru='Движение средств по счету в банке за пределами РФ'"));
	КонецЕсли;
...
Процедура УправлениеЗакладкойУведомлений(Вид = Неопределено)
	...
	Если НЕ СуществуетРегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Видимость = Ложь; // сведения о доле доходов от деятельности музея, театра, библиотеки
	КонецЕсли;
	
	Если НЕ СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ() Тогда
		Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Видимость = Ложь; // движение средств по счету в банке за пределами РФ
	КонецЕсли;
	...
	ИначеЕсли Вид = "ДоходыОтДеятельностиМузеяТеатраБиблиотеки" Тогда
		...
		Элементы.ТаблицаУведомленияКомандаОткрытьДоходыОтДеятельностиМузеяТеатраБиблиотеки.Пометка = Истина;// нажатость подменю
	ИначеЕсли Вид = "ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ" Тогда
		// документ РегламентированныйОтчет с источником РегламентированныйОтчетДоходыОтДеятельностиМузеяТеатраБиблиотеки
		Элементы.ТаблицаУведомленияКомандаОткрытьДвижениеСредствПоСчетуВБанкеЗаПределамиРФ.Пометка = Истина;// нажатость подменю
	...
	Если НЕ ЗначениеЗаполнено(ИмяДокументаУведомлениеОКонтролируемыхСделках) И НЕ СуществуетРегламентированныйОтчетРозничныеЦеныНаТабак()
		...
		И НЕ СуществуетРегламентированныйОтчетДвижениеСредствПоСчетуВБанкеЗаПределамиРФ() Тогда
	...
	// и ДоходыОтДеятельностиМузеяТеатраБиблиотеки, ДвижениеСредствПоСчетуВБанкеЗаПределамиРФ, будет в любом случае
