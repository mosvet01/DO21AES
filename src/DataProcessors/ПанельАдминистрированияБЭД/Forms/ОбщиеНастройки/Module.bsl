...
&НаКлиенте
Процедура ИспользоватьАвтоматическоеСозданиеДОПоЭДПриИзменении(Элемент)
	
	ИзменитьИспользованиеЗадания("СозданиеДокументовДОПоВходящимЭД", ИспользоватьАвтоматическоеСозданиеДОПоЭД);
	Элементы.СозданиеДокументовДОПоВходящимЭД.Доступность = ИспользоватьАвтоматическоеСозданиеДОПоЭД;
	
КонецПроцедуры

&НаКлиенте
Процедура ИспользоватьАвтоматическоеСозданиеИсходящихЭДОПриИзменении(Элемент)
	
	ИзменитьИспользованиеЗадания("СозданиеОбъектовЭДОПоДокументамДО", ИспользоватьАвтоматическоеСозданиеИсходящихЭДО);
	Элементы.СозданиеОбъектовЭДОПоДокументамДО.Доступность = ИспользоватьАвтоматическоеСозданиеИсходящихЭДО;
...
&НаКлиенте
Процедура НастроитьСозданиеДокументовДОПоЭД(Команда)
	
	НастроитьРасписаниеРегламентногоЗадания(ИмяРегламентногоЗаданияСозданиеДокументовЭДОПоЭД());
	
КонецПроцедуры

&НаКлиенте
Процедура НастроитьСозданиеИсходящихЭДО(Команда)
	
	НастроитьРасписаниеРегламентногоЗадания(ИмяРегламентногоЗаданияСозданиеИсходящихЭДО());
...
Процедура ПрочитатьУстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.СервисДоставки") Тогда
		ДоступныеСервисыБинесСеть.Добавить(НСтр("ru = 'оформление доставки в сервисе 1С:Доставка'"));
	КонецЕсли;
...
Процедура УстановитьНастройкиЗаданий()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		...
		ИмяЗадания = ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияСозданиеДокументовЭДОПоЭД();
		УстановитьНастройкуЗадания(ИмяЗадания, Элементы.СозданиеДокументовДОПоВходящимЭД,
			ИспользоватьАвтоматическоеСозданиеДОПоЭД, ЭтоАдминистраторСистемы);
		
		ИмяЗадания = ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияСозданиеИсходящихЭДО();
		УстановитьНастройкуЗадания(ИмяЗадания, Элементы.СозданиеОбъектовЭДОПоДокументамДО,
			ИспользоватьАвтоматическоеСозданиеИсходящихЭДО, ЭтоАдминистраторСистемы);
...
&НаКлиенте
Процедура ОжидатьЗавершенияВыполненияДействийПередИзменениемИспользованияУтверждения(ДлительнаяОперация) Экспорт
...
&НаКлиенте
Функция ИмяРегламентногоЗаданияСозданиеДокументовЭДОПоЭД()
	
	Возврат ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияСозданиеДокументовЭДОПоЭД();
	
КонецФункции

&НаКлиенте
Функция ИмяРегламентногоЗаданияСозданиеИсходящихЭДО()
	
	Возврат ОбменСКонтрагентамиДОСлужебныйКлиентСервер.ИмяРегламентногоЗаданияСозданиеИсходящихЭДО();
