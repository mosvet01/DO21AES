...
Процедура ОбновитьСписокСервер()
	...
	Для Сч = 1 По ПредставленияСсылок.Количество() Цикл
		...
		Если Представление <> Неопределено Тогда
			ПредставлениеИзбранного = МассивПредставлений[Сч - 1];
			Если Не ЗначениеЗаполнено(ПредставлениеИзбранного) Тогда
				ПредставлениеИзбранного = Представление.Текст;
			КонецЕсли;	
			СписокИзбранных.Добавить(МассивСсылок[Сч - 1], ПредставлениеИзбранного);
		КонецЕсли;	
