		...
		Новый ФорматированнаяСтрока(
			Новый ФорматированнаяСтрока(
				НСтр("ru='Подробнее о параметрах отправки push-уведомлений через сервис фирмы ""1С"" можно прочитать на сайте ИТС.
					|'")),
			Новый ФорматированнаяСтрока(НСтр("ru='Подробнее'"),,,, "http://its.1c.ru/db/v83doc#bookmark:dev:TI000001548"));
	...
	Элементы.ИспользоватьAPNS.РасширеннаяПодсказка.Заголовок = 
		Новый ФорматированнаяСтрока(
			Новый ФорматированнаяСтрока(
				...
				|'")),
			Новый ФорматированнаяСтрока(НСтр("ru='Подробнее'"),,,, "http://its.1c.ru/db/v83doc#bookmark:dev:TI000001546"));
		
	Элементы.ИспользоватьFCM.РасширеннаяПодсказка.Заголовок = 
		Новый ФорматированнаяСтрока(
			Новый ФорматированнаяСтрока(
				НСтр("ru='Подробнее о параметрах отправки push-уведомлений через Firebase Google Cloud можно прочитать на сайте ИТС.
				|'")),
			Новый ФорматированнаяСтрока(НСтр("ru='Подробнее'"),,,, "http://its.1c.ru/db/v83doc#bookmark:dev:TI000001547"));
...
Процедура НастроитьДоступностьЭлементовGCMНаСервере()
	...
	Элементы.КлючCервераОтправителяFCM.Доступность = КонстантыНабор.ИспользоватьFCM;
