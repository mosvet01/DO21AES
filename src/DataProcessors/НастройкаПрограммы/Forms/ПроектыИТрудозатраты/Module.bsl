...
Процедура ПриОткрытии(Отказ)
	ОбновитьПодсказкуПолитикиУчетаРабочегоВремени();
КонецПроцедуры
...
&НаКлиенте
Процедура ПолитикаУчетаРабочегоВремениПриИзменении(Элемент)
	ОбновитьПодсказкуПолитикиУчетаРабочегоВремени();
КонецПроцедуры
...
&НаКлиенте
Процедура ОбновитьПодсказкуПолитикиУчетаРабочегоВремени()
	
	Если НаборКонстант.ПолитикаУчетаРабочегоВремени = 
		ПредопределенноеЗначение("Перечисление.ПолитикиУчетаРабочегоВремени.НеУчитывать") Тогда
		Элементы.ПолитикаУчетаРабочегоВремени.Подсказка = НСтр("ru = 'Учет времени документами не ведется'");
	ИначеЕсли НаборКонстант.ПолитикаУчетаРабочегоВремени = 
		ПредопределенноеЗначение("Перечисление.ПолитикиУчетаРабочегоВремени.ИспользоватьЕжедневныеОтчеты") Тогда
		Элементы.ПолитикаУчетаРабочегоВремени.Подсказка = НСтр("ru = 'Учет ведется ежедневными отчетами'");
	ИначеЕсли НаборКонстант.ПолитикаУчетаРабочегоВремени = 
		ПредопределенноеЗначение("Перечисление.ПолитикиУчетаРабочегоВремени.ИспользоватьЕженедельныеОтчеты") Тогда
		Элементы.ПолитикаУчетаРабочегоВремени.Подсказка = НСтр("ru = 'Учет ведется еженедельными отчетами'");
	ИначеЕсли НаборКонстант.ПолитикаУчетаРабочегоВремени = 
		ПредопределенноеЗначение("Перечисление.ПолитикиУчетаРабочегоВремени.ИспользоватьЕжедневныеИЕженедельныеОтчеты") Тогда
		Элементы.ПолитикаУчетаРабочегоВремени.Подсказка = НСтр("ru = 'Учет - ежедневными отчетами, итоги - еженедельными'");
	Иначе
		Элементы.ПолитикаУчетаРабочегоВремени.Подсказка = "";
	КонецЕсли;
