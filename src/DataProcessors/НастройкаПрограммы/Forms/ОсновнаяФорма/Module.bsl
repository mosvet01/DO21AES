...
Процедура ПриСозданииНаСервереРедакцииКонфигурации()	
	...
	Команды.ДанныеПредприятия.Заголовок = РедакцииКонфигурацииКлиентСервер.ДанныеПредприятия();
	
	Элементы.ДанныеПредприятияРасширеннаяПодсказка.Заголовок 
		= РедакцииКонфигурацииКлиентСервер.УстановкаСведенийОПредприятии();
