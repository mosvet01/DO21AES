...
Функция ОписаниеОшибкиЗапретаФормированияДокумента(ЗначенияКлюча)
	...
	Ошибка.Вставить("КлючСообщения", РегистрыСведений.НастройкиОтправкиЭлектронныхДокументовПоВидам.СоздатьКлючЗаписи(
		ЗначенияКлюча));
...
Функция ОписаниеОшибкиЗапретаФормированияВнутреннегоДокумента(ЗначенияКлюча, ИдентификаторОбъектаУчета)
	...
	Ошибка.Вставить("КлючСообщения", РегистрыСведений.НастройкиВнутреннегоЭДО.СоздатьКлючЗаписи(
		ЗначенияКлюча));
