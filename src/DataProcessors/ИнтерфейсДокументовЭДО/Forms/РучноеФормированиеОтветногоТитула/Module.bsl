...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВернутьДанныеОтветногоТитула")
		И Параметры.ВернутьДанныеОтветногоТитула = Истина Тогда
		
		ЭлектронныйДокумент = Параметры.ЭлектронныйДокумент;
		ВернутьДанныеОтветногоТитула = Истина;
		Элементы.ПодписатьИОтправить.Заголовок = НСтр("ru = 'Сформировать ответ'");
		Заголовок = СтрШаблон(НСтр("ru = 'Результат приема %1'"), Параметры.ЭлектронныйДокумент);
	Иначе
...
Процедура ПодписатьИОтправить(Команда)
	...
	Если ВернутьДанныеОтветногоТитула Тогда
