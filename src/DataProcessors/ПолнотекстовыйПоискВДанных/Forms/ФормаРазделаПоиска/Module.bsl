...
Процедура ОК(Команда)
	...
	Если ПолнотекстовыйПоискСерверДокументооборот.ЭтоСтандартныйРазделПоиска(Наименование) Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Наименование раздела совпадает со стандартным разделом поиска. Переименуйте раздел.'"));
		Возврат;
	КонецЕсли;
