...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.СрокИсполненияВремя.РастягиватьПоГоризонтали = Ложь;
	
	Элементы.НовыйСрокДата.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.НовыйСрокДата.РастягиватьПоГоризонтали = Истина;
	Элементы.НовыйСрокВремя.РастягиватьПоГоризонтали = Ложь;
