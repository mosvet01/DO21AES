	...
	Если Настройка = Подписка Тогда
		...
		Если СпособУведомления = Перечисления.СпособыУведомления.ПоПочте Тогда
			...
			Если ВидСобытия = Справочники.ВидыБизнесСобытий.СозданиеЗадачи
				...
				Или ВидСобытия = Перечисления.СобытияУведомлений.НапоминаниеОЗамереТемпературы
				Или ВидСобытия = Перечисления.СобытияУведомлений.ПоявлениеЗамераСПовышеннойТемпературой
				Или ВидСобытия = Перечисления.СобытияУведомлений.ОтчетОЗамерахТемпературы
				Или ВидСобытия = Перечисления.СобытияУведомлений.НеУказанИсполнительПроектнойЗадачи
				Или ВидСобытия = Перечисления.СобытияУведомлений.ПросроченаОценкаКонтрольнойТочки
				Или ВидСобытия = Перечисления.СобытияУведомлений.ПодошелСрокЗаявкиНаОплату
				Или ВидСобытия = Перечисления.СобытияУведомлений.ОтсутствуетАвансовыйОтчет
				Или ВидСобытия = Перечисления.СобытияУведомлений.ОтсутствуетОригинал
