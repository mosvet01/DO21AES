		...
		Если Выборка.Следующий() Тогда
			...
			Попытка
				...
				Если МассивФайлов.Количество() = 0 Тогда
					...
					НСтр("ru = 'СВД.ОтравкаПолучателю.WS'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			...
			Исключение
				...
				ОтменитьТранзакцию();
				Информация = ИнформацияОбОшибке();
				ИмяСобытия = НСтр("ru = 'СВД.ОтравкаПолучателю.WS'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
