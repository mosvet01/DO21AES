...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Настроим "Отложить все".
	Элементы.ГруппаОтложитьВсеНаМК.Видимость = Истина;
	
	Элементы.КнопкаОтложить.Заголовок = НСтр("ru = 'Отложить все'");
	Элементы.КнопкаОтложить.КнопкаПоУмолчанию = Истина;
	Элементы.КнопкаОтложить.РастягиватьПоГоризонтали = Истина;
	Элементы.Переместить(Элементы.КнопкаОтложить, Элементы.ГруппаОтложитьВсеНаМК);
	
	Элементы.СрокПовторногоОповещения.Заголовок = НСтр("ru = 'на'");
	Элементы.СрокПовторногоОповещения.РастягиватьПоГоризонтали = Истина;
	Элементы.СрокПовторногоОповещения.Ширина = 10;
	Элементы.СрокПовторногоОповещения.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.Переместить(Элементы.СрокПовторногоОповещения, Элементы.ГруппаОтложитьВсеНаМК);
	
	// Скроем некотрое элементы.
	Элементы.КнопкаОткрыть.Видимость = Ложь;
	
	Элементы.КнопкаОткрыть.ТолькоВоВсехДействиях = Истина;
	Элементы.КнопкаПрекратить.ТолькоВоВсехДействиях = Истина;
	
	// Перенесем команды действий со списком в ком. панель.
	Элементы.Переместить(Элементы.НапоминанияКонтекстноеМенюВывестиСписок, Элементы.ПанельКнопок);
	Элементы.Переместить(Элементы.НапоминанияКонтекстноеМенюКопироватьВБуферОбмена, Элементы.ПанельКнопок);
	Элементы.Переместить(Элементы.НапоминанияКонтекстноеМенюВыделитьВсе, Элементы.ПанельКнопок);
	
	// Перенес команды из ком.панели в контекстное меню.
	Элементы.Переместить(Элементы.КнопкаПрекратить, Элементы.Напоминания.КонтекстноеМеню);
	
	// Поправим заголовки у команд.
	Элементы.НапоминанияКонтекстноеМенюОткрыть.Заголовок = НСтр("ru = 'Открыть'");
	Элементы.НапоминанияКонтекстноеМенюИзменить.Заголовок = НСтр("ru = 'Изменить'");
