...
Функция УстановитьНастройку(Пользователь, Событие, Настройка, ЗначениеНастройки) Экспорт
	...
	ПользовательСобытия = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Событие, "Пользователь");
	...
	МенеджерЗаписи.Пользователь = ПользовательСобытия;
...
Функция ПолучитьНастройку(Пользователь, Событие, Настройка) Экспорт
	...
	Запрос.УстановитьПараметр("Пользователь", ПользовательСобытия);
