...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ИначеЕсли ЗначениеЗаполнено(ТекущийОбъект.Окончание) И ЗначениеЗаполнено(ТекущийОбъект.Начало) Тогда 
		ТекущийОбъект.Длительность = ?(ТекущийОбъект.Окончание - ТекущийОбъект.Начало >= 0,
			ТекущийОбъект.Окончание - ТекущийОбъект.Начало,
			ТекущийОбъект.Окончание - ТекущийОбъект.Начало + 86400);
	КонецЕсли;	
...
Процедура ОбновитьПодсказкуЗаполночь()
	Если ЗначениеЗаполнено(Запись.Начало)
		И ЗначениеЗаполнено(Запись.Окончание)
		И Запись.Начало > Запись.Окончание Тогда
