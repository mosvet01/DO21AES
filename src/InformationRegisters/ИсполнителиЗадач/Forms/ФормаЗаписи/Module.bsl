...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.УдалитьРольИсполнителя = РольИсполнителя;
	ТекущийОбъект.УдалитьОсновнойОбъектАдресации = ОсновнойОбъектАдресации;
	ТекущийОбъект.УдалитьДополнительныйОбъектАдресации = ДополнительныйОбъектАдресации;
