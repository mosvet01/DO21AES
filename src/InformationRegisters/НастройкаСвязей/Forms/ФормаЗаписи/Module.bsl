...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.ТипСвязи) Тогда
		ПротоколированиеРаботыПользователей.ЗаписатьОткрытие(Запись.ТипСвязи);
	КонецЕсли;	
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ПротоколированиеРаботыПользователей.ЗаписатьИзменение(Запись.ТипСвязи);	
...
Процедура ПоказатьПредупреждениеОДокументахСНезаполненнойСвязью()
	...
	Если ЧислоДокументовСНезаполненнойСвязью <> 0 Тогда
		...
		Иначе
			...
			ИначеЕсли ТипСсылки = Тип("СправочникСсылка.ВидыВходящихДокументов") Тогда 
				СтрокаНазваниеОбъекта = НСтр("ru = 'входящих документов'");
			ИначеЕсли ТипСсылки = Тип("СправочникСсылка.ВидыИсходящихДокументов") Тогда 
				СтрокаНазваниеОбъекта = НСтр("ru = 'исходящих документов'");
			ИначеЕсли ТипСсылки = Тип("СправочникСсылка.ВидыВнутреннихДокументов") Тогда 
				СтрокаНазваниеОбъекта = НСтр("ru = 'внутренних документов'");
			КонецЕсли;	
