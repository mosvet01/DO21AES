...
Процедура МК_НастроитьЭлементыФормы()
	...
	МК_ВыровнятьЭлементФормы(Элементы.Показывать);
	МК_ВыровнятьЭлементФормы(Элементы.ПоДокументу);
	МК_ВыровнятьЭлементФормы(Элементы.ПоПользователю);
	
	Элементы.ТипЭкземпляра.Видимость = Ложь;
	Элементы.НомерЭкземпляра.Видимость = Ложь;
	...
	Элементы.Переместить(Элементы.НаименованиеДокумента, Элементы.МК_ПерваяКолонка);
	Элементы.Переместить(Элементы.ГруппаКомуПередан, Элементы.МК_ПерваяКолонка);
	Элементы.Переместить(Элементы.Период, Элементы.МК_ВтораяКолонка);
	
	Элементы.Переместить(Элементы.ОтметитьВозврат, Элементы.Список.КонтекстноеМеню);
	Элементы.ОткрытьОтчеты.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	...
	Элементы.Контрагент.Шрифт = ШрифтыСтиля.МК_ШрифтАвтораИсполнителя;
	Элементы.Контрагент.ЦветТекста = ЦветаСтиля.МК_ЦветАвтораИсполнителя;
