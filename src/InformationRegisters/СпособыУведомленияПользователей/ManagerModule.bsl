...
Функция ПолучитьСпособыУведомленияВсехПользователей() Экспорт
	...
	ВидыКонтактнойИнформация = УправлениеКонтактнойИнформацией.ВидыКонтактнойИнформацииОбъекта(Пользователь);
...
Процедура УдалитьСпособУведомленияВсехПользователей(ВидКонтактнойИнформации) Экспорт
	...
	Иначе
		ТекстОшибки = СтрШаблон(НСтр("ru = 'Тип контактной информации %1 не подходит для уведомления всех пользователей.'"), ВидКонтактнойИнформации.Тип);
