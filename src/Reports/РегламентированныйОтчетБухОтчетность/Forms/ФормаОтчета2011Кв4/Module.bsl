...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РегламентированнаяОтчетность.ПоместитьВКэш(ДеревоНастроекФормаОтчета, УникальныйИдентификатор,
...
Процедура СохранитьПояснения(Команда)
	...
	Если АдресФайлаВХранилище <> Неопределено Тогда
		ИмяСохраняемогоФайла = "Пояснения к бухгалтерскому балансу и отчету о финансовых результатах за "
		                     + НРег(СтруктураРеквизитовФормы.СтрПериодОтчета) + " (" + СтруктураРеквизитовФормы.НаимОрганизации + ")";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ ИмяРаздела = "ДополнительныеФайлы" Тогда
		Если ТабличныйДокумент.Области.Количество() = 0 Тогда
			ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + ?(ИмяРаздела = "ФормаОтчета", СтруктураОтчета.ОПУ.ИмяМакета, СтруктураОтчета[ИмяРаздела].ИмяМакета)));
		КонецЕсли;
	КонецЕсли;
...
Функция ЗаполнитьАвтоНаСервере(ИмяРаздела = Неопределено, ВремяНачалаОперации = Неопределено)
	...
	ПараметрыОтчета.Вставить("ЗаполнятьОЦИПС",      (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "ОЦИПС")       И СтраницаВидимаНаСервере("ОЦИПС"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения1", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения1")  И СтраницаВидимаНаСервере("Пояснения1"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения2", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения2")  И СтраницаВидимаНаСервере("Пояснения2"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения4", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения4")  И СтраницаВидимаНаСервере("Пояснения4"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения5", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения5")  И СтраницаВидимаНаСервере("Пояснения5"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения6", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения6")  И СтраницаВидимаНаСервере("Пояснения6"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения7", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения7")  И СтраницаВидимаНаСервере("Пояснения7"));
	ПараметрыОтчета.Вставить("ЗаполнятьПояснения8", (ЗаполнятьВсеВидимые ИЛИ ИмяРаздела = "Пояснения8")  И СтраницаВидимаНаСервере("Пояснения8"));
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", Знач ОбластьИмя = "")
	...
	Если ИмяСтраницыПанели = "Баланс" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Баланс" Тогда
			...
			Если Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20141101'
				И Форма.СтруктураОтчета.РасчетАктивов.ИмяМакета = "РасчетАктивов_2014Кв4" Тогда
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				мБаланс.П000100110004
				= мБаланс.П000100111004
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				мБаланс.П000100110006
				= мБаланс.П000100111006
	...
	Если ИмяСтраницыПанели = "ФормаОтчета" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "ФормаОтчета" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100210004, ОбластьИмя) > 0 Тогда
				
				П000100211004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100211004.Значение);
				П000100212004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100212004.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100210005, ОбластьИмя) > 0 Тогда
				
				П000100211005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100211005.Значение);
				П000100212005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100212005.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100220004, ОбластьИмя) > 0 Тогда
				
				П000100210004 = мФормаОтчета.П000100210004.Значение;
				П000100221004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100221004.Значение);
				П000100222004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100222004.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100220005, ОбластьИмя) > 0 Тогда
				
				П000100210005 = мФормаОтчета.П000100210005.Значение;
				П000100221005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100221005.Значение);
				П000100222005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100222005.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100230004, ОбластьИмя) > 0 Тогда
				
				П000100220004 = мФормаОтчета.П000100220004.Значение;
				
				П000100231004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100231004.Значение);
				П000100232004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100232004.Значение);
				П000100233004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100233004.Значение);
				П000100234004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100234004.Значение);
				П000100235004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100235004.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100230005, ОбластьИмя) > 0 Тогда
				
				П000100220005 = мФормаОтчета.П000100220005.Значение;
				
				П000100231005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100231005.Значение);
				П000100232005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100232005.Значение);
				П000100233005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100233005.Значение);
				П000100234005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100234005.Значение);
				П000100235005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100235005.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100240004, ОбластьИмя) > 0 Тогда
				
				П000100230004 = мФормаОтчета.П000100230004.Значение;
				
				П000100241004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100241004.Значение);
				П000100243004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100243004.Значение);
				П000100245004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100245004.Значение);
				П000100246004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100246004.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100240005, ОбластьИмя) > 0 Тогда
				
				П000100230005 = мФормаОтчета.П000100230005.Значение;
				
				П000100241005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100241005.Значение);
				П000100243005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100243005.Значение);
				П000100245005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100245005.Значение);
				П000100246005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100246005.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100250004, ОбластьИмя) > 0 Тогда
				
				П000100240004 = мФормаОтчета.П000100240004.Значение;
				
				П000100251004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100251004.Значение);
				П000100252004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100252004.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100250005, ОбластьИмя) > 0 Тогда
				
				П000100240005 = мФормаОтчета.П000100240005.Значение;
				
				П000100251005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100251005.Значение);
				П000100252005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100252005.Значение);
			...
			Если Форма.СтруктураРеквизитовФормы.ПрименениеЕНВД Тогда
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21101") <> Неопределено Тогда
					П000102110104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110104.Значение);
					П000102110105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110105.Значение);
				Иначе
					П000102110104 = 0;
					П000102110105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21102") <> Неопределено Тогда
					П000102110204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110204.Значение);
					П000102110205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110205.Значение);
				Иначе
					П000102110204 = 0;
					П000102110205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21201") <> Неопределено Тогда
					П000102120104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120104.Значение);
					П000102120105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120105.Значение);
				Иначе
					П000102120104 = 0;
					П000102120105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21202") <> Неопределено Тогда
					П000102120204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120204.Значение);
					П000102120205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120205.Значение);
				Иначе
					П000102120204 = 0;
					П000102120205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22101") <> Неопределено Тогда
					П000102210104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210104.Значение);
					П000102210105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210105.Значение);
				Иначе
					П000102210104 = 0;
					П000102210105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22102") <> Неопределено Тогда
					П000102210204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210204.Значение);
					П000102210205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210205.Значение);
				Иначе
					П000102210204 = 0;
					П000102210205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22201") <> Неопределено Тогда
					П000102220104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220104.Значение);
					П000102220105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220105.Значение);
				Иначе
					П000102220104 = 0;
					П000102220105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22202") <> Неопределено Тогда
					П000102220204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220204.Значение);
					П000102220205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220205.Значение);
				Иначе
					П000102220204 = 0;
					П000102220205 = 0;
				КонецЕсли;
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102100104, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102100104.Значение = П000102100104;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102100105, ОбластьИмя) > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102100204, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102100204.Значение = П000102100204;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102100205, ОбластьИмя) > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102200104, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102200104.Значение = П000102200104;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102200105, ОбластьИмя) > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102200204, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102200204.Значение = П000102200204;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102200205, ОбластьИмя) > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102300104, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102300104.Значение = П000102300104;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102300105, ОбластьИмя) > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102300204, ОбластьИмя) > 0 Тогда
					мФормаОтчета.П000102300204.Значение = П000102300204;
				КонецЕсли;
				
				Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
					Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000102300205, ОбластьИмя) > 0 Тогда
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100211004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100211004);
				П000100212004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100212004);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100211005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100211005);
				П000100212005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100212005);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100221004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100221004);
				П000100222004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100222004);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100221005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100221005);
				П000100222005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100222005);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100231004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100231004);
				П000100232004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100232004);
				П000100233004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100233004);
				П000100234004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100234004);
				П000100235004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100235004);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100231005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100231005);
				П000100232005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100232005);
				П000100233005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100233005);
				П000100234005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100234005);
				П000100235005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100235005);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100241004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100241004);
				П000100243004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100243004);
				П000100245004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100245004);
				П000100246004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100246004);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100241005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100241005);
				П000100243005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100243005);
				П000100245005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100245005);
				П000100246005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100246005);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100251004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100251004);
				П000100252004 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100252004);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100251005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100251005);
				П000100252005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100252005);
			...
			Если Форма.СтруктураРеквизитовФормы.ПрименениеЕНВД Тогда
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21101") <> Неопределено Тогда
					П000102110104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110104);
					П000102110105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110105);
				Иначе
					П000102110104 = 0;
					П000102110105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21102") <> Неопределено Тогда
					П000102110204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110204);
					П000102110205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102110205);
				Иначе
					П000102110204 = 0;
					П000102110205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21201") <> Неопределено Тогда
					П000102120104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120104);
					П000102120105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120105);
				Иначе
					П000102120104 = 0;
					П000102120105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока21202") <> Неопределено Тогда
					П000102120204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120204);
					П000102120205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102120205);
				Иначе
					П000102120204 = 0;
					П000102120205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22101") <> Неопределено Тогда
					П000102210104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210104);
					П000102210105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210105);
				Иначе
					П000102210104 = 0;
					П000102210105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22102") <> Неопределено Тогда
					П000102210204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210204);
					П000102210205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102210205);
				Иначе
					П000102210204 = 0;
					П000102210205 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22201") <> Неопределено Тогда
					П000102220104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220104);
					П000102220105 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220105);
				Иначе
					П000102220104 = 0;
					П000102220105 = 0;
				КонецЕсли;
				...
				Если ВключенныеДопСтроки.Найти("ДопСтрока22202") <> Неопределено Тогда
					П000102220204 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220204);
					П000102220205 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
					Форма, мФормаОтчета.П000102220205);
				Иначе
					П000102220204 = 0;
					П000102220205 = 0;
				КонецЕсли;
	...
	Если ИмяСтраницыПанели = "ОИК" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "ОИК" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100340006_1, ОбластьИмя) > 0 Тогда
				
				П100100340003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340003_1.Значение);
				П100100340004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340004_1.Значение);
				П100100340005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340005_1.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100341006_1, ОбластьИмя) > 0 Тогда
				
				П100100341003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341003_1.Значение);
				П100100341004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341004_1.Значение);
				П100100341005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341005_1.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100342006_1, ОбластьИмя) > 0 Тогда
				
				П100100342003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342003_1.Значение);
				П100100342004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342004_1.Значение);
				П100100342005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342005_1.Значение);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100350003_1, ОбластьИмя) > 0 Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100350004_1, ОбластьИмя) > 0 Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100350005_1, ОбластьИмя) > 0 Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П100100350006_1, ОбластьИмя) > 0 Тогда
				
				П100100350003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350003_1.Значение);
				П100100350004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350004_1.Значение);
				П100100350005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350005_1.Значение);
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П100100340003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340003_1);
				П100100340004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340004_1);
				П100100340005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100340005_1);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П100100341003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341003_1);
				П100100341004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341004_1);
				П100100341005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100341005_1);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П100100342003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342003_1);
				П100100342004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342004_1);
				П100100342005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100342005_1);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П100100350003_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350003_1);
				П100100350004_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350004_1);
				П100100350005_1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П100100350005_1);
	...
	Если ИмяСтраницыПанели = "ОЦИПС" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "ОЦИПС" Тогда
		...
		Иначе
			...
			мФормаОтчета = Форма.СтруктураДанныхОЦИПС;
	...
	Если ИмяСтраницыПанели = "Пояснения6" Тогда
		РасчетНаСервере_Пояснения6(Форма, ОбластьИмя);
	КонецЕсли;
	...
	Если ИмяСтраницыПанели = "Пояснения9" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Пояснения9" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100590003, ОбластьИмя) > 0 Тогда
				
				П000100590103 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590103.Значение);
				П000100590503 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590503.Значение);
				
				мФормаОтчета.П000100590003.Значение = П000100590103 + П000100590503;
				
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100590004, ОбластьИмя) > 0 Тогда
				
				П000100590104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590104.Значение);
				П000100590504 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590504.Значение);
				
				мФормаОтчета.П000100590004.Значение = П000100590104 + П000100590504;
				
			КонецЕсли;
			
		Иначе
			
			мФормаОтчета = Форма.СтруктураДанныхПояснения9;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000100590003, ОбластьИмя) > 0 Тогда
				
				П000100590103 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590103);
				П000100590503 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590503);
				
				мФормаОтчета.П000100590003 = П000100590103 + П000100590503;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				П000100590104 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590104);
				П000100590504 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(
				Форма, мФормаОтчета.П000100590504);
				
				мФормаОтчета.П000100590004 = П000100590104 + П000100590504;
...
&НаКлиентеНаСервереБезКонтекста
Процедура РасчетНаСервере_Пояснения6(Форма, ОбластьИмя)
...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если (СписокСохранения.Свойство("ВерсияФормы", ВерсияФормы) И ВерсияФормы <> СтруктураРеквизитовФормы.мВерсияФормы)
		...
		Если ЭлементВДереве <> Неопределено Тогда
			ЭлементВДереве.Представление = ЗаголовокСтраницыВДеревеРазделовОтчета(
				"РасчетАктивов", СтруктураОтчета.РасчетАктивов.ИмяМакета);
		КонецЕсли;
	...
	Если НЕ ИмяТекРаздела = "ДополнительныеФайлы" Тогда
		ТабличныйДокумент.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_" + ?(ИмяТекРаздела = "ФормаОтчета", СтруктураОтчета.ОПУ.ИмяМакета, СтруктураОтчета[ИмяТекРаздела].ИмяМакета)));
...
//     "ПоказатьБланкКНД0710099" - формирование бланков с добавлением формы с титульным листом бланка по КНД 0710099
//
&НаСервере
...
Процедура ВывестиНаПечатьКНД0710099(ПараметрыПечати)
	...
	Иначе
		// Обычная отчетность.
		ПериодОтчетности = СоответствиеМесяцаОкончанияПериодаОтчетаПризнакуПериода[Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)];
	КонецЕсли;
	...
	СтруктураАдреса = РегламентированнаяОтчетностьКлиентСервер.РазложитьАдрес(СтруктураРеквизитовФормы.мАдресДляВыгрузки);
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2015-01-01' Тогда
		...
		Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2016-01-01' Тогда
			ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2016Кв1_КНД0710099_1");
		Иначе
			ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2015Кв1_КНД0710099_1");
		КонецЕсли;
	...
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2013-01-01' Тогда
		...
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2013Кв1_КНД0710099_1");
	...
	Иначе
		...
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2011Кв4_КНД0710099_1");
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2015-01-01' Тогда
		Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2016-01-01' Тогда
			ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2016Кв1_КНД0710099_2");
		Иначе
			ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2015Кв1_КНД0710099_2");
		КонецЕсли;
		ПечатнаяФорма.ПолеСверху = 5;
		ПечатнаяФорма.ПолеСправа = 5;
		ПечатнаяФорма.ПолеСнизу  = 5;
		ПечатнаяФорма.ПолеСлева  = 5;
	ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2013-01-01' Тогда
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2013Кв1_КНД0710099_2");
	Иначе
		ПечатнаяФорма = ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаПечати2011Кв4_КНД0710099_2");
	КонецЕсли;
...
Процедура ВывестиНаПечатьЛист(Парам1)
	...
	ИначеЕсли Парам1.ИмяСтраницы = "ОИК" Тогда
...
&НаСервере
Функция НоваяКартаЛистовРаздела()
	
	КартаЛистовРаздела = Новый ТаблицаЗначений;
	КартаЛистовРаздела.Колонки.Добавить("Верх");
	КартаЛистовРаздела.Колонки.Добавить("Низ");
	
	Возврат КартаЛистовРаздела;
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если КолонкаРазделыОтчетаСокрНаим = "Баланс"
	 ИЛИ КолонкаРазделыОтчетаСокрНаим = "ФормаОтчета" Тогда
	...
	Если КолонкаРазделыОтчетаСокрНаим = "ОЦИПС" Тогда
		
		Элементы.ЗаполнитьТекущий.Доступность = Ложь;
		
		ТаблВариантыЗаполнения = ЭтотОбъект["ТаблицаВариантыЗаполнения" + КолонкаРазделыОтчетаСокрНаим];
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь, СведенияОбОрганизации = Неопределено)
	...
	Если ВПрограммеИзмененаДатаПодписи Тогда
		...
		КонецЕсли;
		Если (Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '2012-12-01' ИЛИ Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "РасчетАктивов")
...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1.Представление            = ЗаголовокСтраницыВДеревеРазделовОтчета(
	                                         СтрокаУровня1.ИмяСтраницы, СтруктураОтчета.ОЦИПС.ИмяМакета);
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	...
	СтрокаУровня1.ИмяСтраницы              = "РасчетАктивов";
	СтрокаУровня1.Представление            = ЗаголовокСтраницыВДеревеРазделовОтчета(
	                                         СтрокаУровня1.ИмяСтраницы, СтруктураОтчета.РасчетАктивов.ИмяМакета);
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = ПризнакПечатиСтраницы;
	СтрокаУровня1.ПоказатьСтраницу         = ПризнакПоказаСтраницы;
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
...
&НаСервере
Функция ЗаголовокСтраницыВДеревеРазделовОтчета(ИмяРаздела, ИмяМакета)
	
	Если ИмяРаздела = "РасчетАктивов" Тогда
		Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2014-11-01' И ИмяМакета = "РасчетАктивов_2014Кв4" Тогда
	...
	ИначеЕсли ИмяРаздела = "ОЦИПС" Тогда
		Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2018-01-01' И ИмяМакета = "ОЦИС" Тогда
		...
		Для Каждого Пок Из СведенияОбОрганизации Цикл
			Если ДанныеРаздела.Свойство(Пок.Ключ) Тогда
				Если Пок.Ключ = "ОргБухгалтер" Тогда
					Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '2012-12-01'
						ИЛИ Раздел.ИмяСтраницы = "РасчетАктивов" Тогда
...
Функция СформироватьНастройкиФормыВыбораПечати()
	...
	ПечатьPDF417Разрешена = НЕ СтруктураРеквизитовФормы.ИП
	                      И ((СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '2012-01-01' И Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) % 3 = 0)
	                    ИЛИ (СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2012-01-01' И Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 12)
	                    ИЛИ ЭтоЛиквидационнаяОтчетность);
