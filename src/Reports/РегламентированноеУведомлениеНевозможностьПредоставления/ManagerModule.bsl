...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ДатаНачала = Дата("20150101");
	Стр.ДатаКонца = Дата("20190101");
	...
	Для Каждого Стр0 Из Данные.СтруктураРеквизитов._СвНевозмПред Цикл
		...
		Для Каждого Стр1 Из Стр0.ДокИнф.Строки Цикл
			Если Не ЗначениеЗаполнено(Стр1.СведДокИнф) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указаны детали документа из требования", "СведенияОДокументах", "_СвНевозмПред", Стр0.УИД));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(Стр1.ПорНомДок) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Номер документа из требования не указан", "СведенияОДокументах", "_СвНевозмПред", Стр0.УИД));
			КонецЕсли;
