...
Функция СформироватьСписокЛистовФорма2020_4(Объект, ЕстьВыходЗаГраницы) Экспорт
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		...
		Если Стр.ИДНаименования = "ЛистВ" Тогда
			ВывестиБланк2020_4_ЛистВ(СтруктураПараметров, Стр, ЕстьВыходЗаГраницы, Объект, Листы, НомСтр);
			
		ИначеЕсли Стр.ИДНаименования = "ЛистД1" Тогда
			ВывестиБланк2020_4_ЛистД1(СтруктураПараметров, Стр, Объект, Листы, НомСтр);
			
		ИначеЕсли Стр.ИДНаименования = "ЛистД2" Тогда
			ВывестиБланк2020_4_ЛистД2(СтруктураПараметров, Стр, Объект, Листы, НомСтр);
...
Процедура ВывестиБланк2020_4_ЛистВ(СтруктураПараметров, Стр, ЕстьВыходЗаГраницы, Объект, Листы, НомСтр)
...
Процедура ВывестиБланк2020_4_ЛистД1(СтруктураПараметров, Стр, Объект, Листы, НомСтр)
...
Процедура ВывестиБланк2020_4_ЛистД2(СтруктураПараметров, Стр, Объект, Листы, НомСтр)
...
Функция ПолучитьФормуПоУмолчанию() Экспорт
	...
	Возврат "Отчет.РегламентированноеУведомлениеФормаР24001.Форма.Форма2020_4";
