...
Функция ТаблицаЗаменИменМногострочныхЧастей()
	...
	//Замены.Вставить("МнгСтр1", "ИнфВнесИзм");
	//Замены.Вставить("МнгСтр2", "ИнфСВК");
	//Замены.Вставить("МнгСтр3", "ИнфСВК");
	//Замены.Вставить("МнгСтр4", "ИнфСВК");
	//Замены.Вставить("МнгСтр5", "ПорСрокДок");
	//Замены.Вставить("МнгСтр6", "ПорСрокДок");
	//Замены.Вставить("МнгСтр7", "ПредДокСВК");
	Возврат Замены;
КонецФункции
...
Функция ДатаИзСтроки(Стр)
	Если СтрДлина(Стр) = 5 И СтрНайти(Стр, ".") = 3 Тогда 
		Возврат ОТД.ПривестиЗначение("2020" + Прав(Стр, 2) + Лев(Стр, 2));
	Иначе 
		Возврат Неопределено;
	КонецЕсли
КонецФункции
...
Функция ВремяИзСтроки(Стр)
	Если СтрДлина(Стр) = 5 И СтрНайти(Стр, ".") = 3 Тогда 
		Возврат ОТД.ПривестиЗначение("20200101" + Лев(Стр, 2) + Прав(Стр, 2) + "00");
	Иначе 
		Возврат Неопределено;
	КонецЕсли
КонецФункции
