...
Процедура ДоступностьПолей()
	Если ЭтоЮЛ Тогда 
		...
		ПредставлениеУведомления.Области["КодВидДок"].Защита = Истина;
		ПредставлениеУведомления.Области["КодВидДок"].ЦветФона = ЦФБ;
		ПредставлениеУведомления.Области["СерНомДок"].Защита = Истина;
		ПредставлениеУведомления.Области["СерНомДок"].ЦветФона = ЦФБ;
		ПредставлениеУведомления.Области["ДатаДок"].Защита = Истина;
		ПредставлениеУведомления.Области["ДатаДок"].ЦветФона = ЦФБ;
		ПредставлениеУведомления.Области["КПП"].Защита = Ложь;
		ПредставлениеУведомления.Области["КПП"].ЦветФона = ЦФЖ;
		ПредставлениеУведомления.Области["ПрЗаяв"].Защита = Истина;
		ПредставлениеУведомления.Области["ПрЗаяв"].ЦветФона = ЦФБ;
	Иначе 
		...
		Иначе
			...
			ПредставлениеУведомления.Области["ДатаДок"].Защита = Истина;
			ПредставлениеУведомления.Области["ДатаДок"].ЦветФона = ЦФБ;
			ПредставлениеУведомления.Области["КодВидДок"].Значение = "";
			ПредставлениеУведомления.Области["СерНомДок"].Значение = "";
			ПредставлениеУведомления.Области["ДатаДок"].Значение = "";
		КонецЕсли;
	КонецЕсли;
	
	Если ПредставлениеУведомления.Области["ПрКБК"].Значение = "1" Тогда 
		ПредставлениеУведомления.Области["КБК"].Защита = Истина;
		ПредставлениеУведомления.Области["КБК"].ЦветФона = ЦФБ;
		ПредставлениеУведомления.Области["КБК"].Значение = "";
		ДанныеУведомления.Титульная.КБК = "";
	Иначе
		ПредставлениеУведомления.Области["КБК"].Защита = Ложь;
		ПредставлениеУведомления.Области["КБК"].ЦветФона = ЦФЖ;
	КонецЕсли;
	
	Если ПредставлениеУведомления.Области["ПРИЗНАК_НП_ПОДВАЛ"].Значение = "1" Тогда 
		ПредставлениеУведомления.Области["НаимДок"].Защита = Истина;
		ПредставлениеУведомления.Области["НаимДок"].ЦветФона = ЦФБ;
		ПредставлениеУведомления.Области["НаимДок"].Значение = "";
		ДанныеУведомления.Титульная.НаимДок = "";
	Иначе
		ПредставлениеУведомления.Области["НаимДок"].Защита = Ложь;
		ПредставлениеУведомления.Области["НаимДок"].ЦветФона = ЦФЖ;
	КонецЕсли;
КонецПроцедуры